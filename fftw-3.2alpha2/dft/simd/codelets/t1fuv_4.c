...
/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 4 -name t1fuv_4 -include t1fu.h */
...
static const ct_desc desc = { 4, "t1fuv_4", twinstr, &GENUS, {9, 6, 2, 0}, 0, 0, 0 };

void X(codelet_t1fuv_4) (planner *p) {
     X(kdft_dit_register) (p, t1fuv_4, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 4 -name t1fuv_4 -include t1fu.h */
...
static const ct_desc desc = { 4, "t1fuv_4", twinstr, &GENUS, {11, 6, 0, 0}, 0, 0, 0 };
