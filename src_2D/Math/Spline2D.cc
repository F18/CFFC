...
void Create_Spline_Converging_Nozzle(Spline2D &Radius_Spline,
				     const double &Xup,
				     const double &Xthroat,
				     const double &Rup,
				     const double &Rthroat,
...
void Create_Spline_Diverging_Nozzle(Spline2D &Radius_Spline,
				    const double &Xthroat,
				    const double &Xdown,
				    const double &Rthroat,
				    const double &Rdown,
 ...
 *                                                              *
 ****************************************************************/
LinkedList<Vector2D> getY(const double &x, const Spline2D &S) {
 ...
 *                                                              *
 ****************************************************************/
LinkedList<Vector2D> getX(const double &y, const Spline2D &S) {
    int i, iNext, found, icount;
 ...
 *                                                              *
 ****************************************************************/
Vector2D getnormal(const Vector2D &X, const Spline2D &S) {
