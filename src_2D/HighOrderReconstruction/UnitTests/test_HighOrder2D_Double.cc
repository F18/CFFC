...
namespace tut
{
  ...
  */
  ...
  void HighOrder2D_object::test<2>()
  {
    ...
    // set HighOrder2D variable
    HighOrder2D<double> HO(3,Cell1D);
  ...
  void HighOrder2D_object::test<4>()
  {
    ...
    // set HighOrder2D variables
    HighOrder2D<double> HO(3,Cell1D), HO_2(3,Cell1D);
  ...
  void HighOrder2D_object::test<9>()
  {
    ...
    // set HighOrder2D variable
    HighOrder2D<double> HO(3,Cell1D), HO_2;
  ...
  void HighOrder2D_object::test<11>()
  {
    ...
    // set HighOrder2D variable
    HighOrder2D<double> HO(3,Cell1D), HO_2(2,Cell1D);
