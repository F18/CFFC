/* Gaussian2DQuadGrid.cc:  Grid Manipulation Subroutines for 2D Gaussian
...
Grid2D_Quad_Block** Multi_Block_Grid(Grid2D_Quad_Block **Grid_ptr,
    ...
    switch(Input_Parameters.i_Grid) {
      case GRID_READ_FROM_DEFINITION_FILE :
        ...
        if (Grid_ptr == NULL) {
	   cout << "\n " << CFFC_Name() 
                << " Gaussian2D ERROR: Unable to open multi-block mesh definition file "
      ...
      case GRID_READ_FROM_GRID_DATA_FILE :
        ...
        if (Grid_ptr == NULL) {
	   cout << "\n " << CFFC_Name() 
                << " Gaussian2D ERROR: Unable to open multi-block mesh data file "
      ...
      case GRID_SQUARE :
        ...
        for ( jBlk = 0; jBlk <= Input_Parameters.Number_of_Blocks_Jdir-1; ++jBlk ) {
		 ...
		 Grid_ptr[iBlk][jBlk].BndNorthSpline.setBCtype(BC_REFLECTION);
              } else {
...
//	break;
	...
	break;
      ...
      case GRID_ADIABATIC_FLAT_PLATE :
        Grid_ptr = Grid_Adiabatic_Flat_Plate(Grid_ptr,
                                             Input_Parameters.Number_of_Blocks_Idir,
		                             Input_Parameters.Number_of_Blocks_Jdir,
                                             Input_Parameters.Plate_Length,
 		                             Input_Parameters.Number_of_Cells_Idir,
...
//        Grid_ptr = Grid_Adiabatic_Pipe(Grid_ptr,
//                                       Input_Parameters.Number_of_Blocks_Idir,
//		                       Input_Parameters.Number_of_Blocks_Jdir,
//                                       Input_Parameters.Pipe_Length,
//                                       Input_Parameters.Pipe_Radius,
...
//        break;
      case GRID_ADIABATIC_CIRCULAR_CYLINDER :
        Grid_ptr = Grid_Adiabatic_Circular_Cylinder(Grid_ptr,
                                                    Input_Parameters.Number_of_Blocks_Idir,
		                                    Input_Parameters.Number_of_Blocks_Jdir,
                                                    Input_Parameters.Cylinder_Radius,
                                                    Input_Parameters.Cylinder_Radius2,
      ...
      case GRID_ADIABATIC_COUETTE :
        Grid_ptr = Grid_Adiabatic_Couette(Grid_ptr,
                                          Input_Parameters.Number_of_Blocks_Idir,
		                          Input_Parameters.Number_of_Blocks_Jdir,
                                          Input_Parameters.Couette_Plate_Separation,
 		                          Input_Parameters.Number_of_Cells_Idir,
		                          Input_Parameters.Number_of_Cells_Jdir,
					  Input_Parameters.Number_of_Ghost_Cells);
      break;
