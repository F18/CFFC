 ...
 *                                                                    *
 **********************************************************************/
void Write_Solution_Block(HighTemp2D_Quad_Block &SolnBlk,
	                  ostream &Out_File) {
 ...
 *                                                                    *
 **********************************************************************/
void Read_Solution_Block(HighTemp2D_Quad_Block &SolnBlk,
	                 istream &In_File) {
...
void Output_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
  ...
  for (int j = SolnBlk.Grid.JNl-SolnBlk.Nghost*ng; j <= SolnBlk.Grid.JNu+SolnBlk.Nghost*ng; j++) {
    for (int i = SolnBlk.Grid.INl-SolnBlk.Nghost*ng; i <= SolnBlk.Grid.INu+SolnBlk.Nghost*ng; i++) {
 ...
 *                                                                    *
 **********************************************************************/
void Output_Nodes_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
                          const int Number_of_Time_Steps,
                          const double &Time,
                          const int Block_Number,
                          const int Output_Title,
 ...
 *                                                                    *
 **********************************************************************/
void Output_Gradients_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
			      const int Number_of_Time_Steps,
			      const double &Time,
			      const int Block_Number,
			      const int Output_Title,
 ...
 *                                                                    *
 **********************************************************************/
void Output_Quasi3D_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
			    HighTemp2D_Input_Parameters &IP,
			    const int Number_of_Time_Steps,
			    const double &Time,
			    const int Block_Number,
 ...
 *                                                                    *
 **********************************************************************/
void Output_Ringleb_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
			    const int Block_Number,
			    const int Output_Title,
			    ostream &Out_File,
			    double &l1_norm,
 ...
 *                                                                    *
 **********************************************************************/
void Output_Viscous_Channel_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
				    const int Block_Number,
				    const int Output_Title,
				    ostream &Out_File,
				    double &l1_norm,
 ...
 *                                                                    *
 **********************************************************************/
void Output_Viscous_Pipe_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
				 const int Block_Number,
				 const int Output_Title,
				 ostream &Out_File,
				 double &l1_norm,
 ...
 *                                                                    *
 **********************************************************************/
void Output_Turbulent_Pipe_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
				   const int Block_Number,
				   const int Output_Title,
 ...
 *                                                                    *
 **********************************************************************/
void Output_Flat_Plate_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
			       const int Block_Number,
  ...
  for (int j = SolnBlk.Grid.JNl; j <= SolnBlk.Grid.JNu; j++) {
    for (int i = SolnBlk.Grid.INl; i <= SolnBlk.Grid.INu; i++) {
      ...
      Rex = (Winf.v.x/Winf.nu())*SolnBlk.Grid.Node[i][j].X.x;   //Rex ADDED HERE !!
  ...
  if (skin_friction_flag) {
	...
	tauw1 = WallShearStress(SolnBlk.W[i][SolnBlk.JCl],
	...
	Cf  = TWO * tauw1 / Winf.rho / sqr(Winf.v.x);

	tauw2 = WallShearStress2(SolnBlk.Grid.xfaceS(i,SolnBlk.JCl),
				   SolnBlk.Grid.Cell[i][SolnBlk.JCl].Xc,
	...
	Cf2  = TWO * tauw2 / Winf.rho / sqr(Winf.v.x);

	double utau = sqrt(fabs(tauw1)/SolnBlk.W[i][SolnBlk.JCl].rho);
	double ywall = abs(SolnBlk.Grid.Cell[i][SolnBlk.JCl].Xc - SolnBlk.Grid.xfaceS(i, SolnBlk.JCl));

	double yplus = utau * ywall / SolnBlk.W[i][SolnBlk.JCl].nu();
 ...
 *                                                                    *
 **********************************************************************/
void Output_Driven_Cavity_Flow_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
				       const int Block_Number,
				       const int Output_Title,
				       ostream &Out_File_u,
				       ostream &Out_File_v,
 ...
 *                                                                    *
 **********************************************************************/
void Output_Backward_Facing_Step_Tecplot(HighTemp2D_Quad_Block &SolnBlk,
					 const int Block_Number,
					 const int Output_Title,
					 ostream &Out_File,
