...
/*****************************************************************************
 *  dRdU.h and dRdU.cc contain Jacobian formulations related to Flame2DState  *
 *                                                                           *
...
extern void dFIdW_Inviscid(DenseMatrix &dRdW, Flame2D_Quad_Block &SolnBlk, 
			   Flame2D_Input_Parameters &Input_Parameters,
			   const int &ii, const int &jj);

extern void dFIdW_Inviscid_HLLE(DenseMatrix &dRdW, Flame2D_Quad_Block &SolnBlk,
				Flame2D_Input_Parameters &Input_Parameters,
				const int &ii, const int &jj,const int Orient);

extern void dFIdW_Inviscid_ROE(DenseMatrix &dRdW, Flame2D_Quad_Block &SolnBlk, 
			       Flame2D_Input_Parameters &Input_Parameters,
			       const int &ii, const int &jj,const int Orient);

extern void dFIdW_Inviscid_ROE_FD(DenseMatrix &dRdW, Flame2D_Quad_Block &SolnBlk, 
				  Flame2D_Input_Parameters &Input_Parameters,
				  const int &ii, const int &jj,const int Orient);

//Needed by inviscid flux Jacobian -- reconstructed higher order left and right solution states
extern int Inviscid_Flux_Used_Reconstructed_LeftandRight_States(Flame2D_pState &Wl, Flame2D_pState &Wr, Vector2D &dX, 
                                                                Flame2D_Quad_Block &SolnBlk, 
                                                                const int &Orient, const int &ii, const int &jj );

extern void dFIdW_Inviscid_AUSM_plus_up(DenseMatrix &dRdW, Flame2D_Quad_Block &SolnBlk, 
					Flame2D_Input_Parameters &Input_Parameters,
					const int &ii, const int &jj,const int Orient);
...
extern void dGVdW_Viscous(DenseMatrix &dRdW, Flame2D_Quad_Block &SolnBlk,
			  Flame2D_Input_Parameters &Input_Parameters, 
			  const int &ii, const int &jj);

// Viscous Jacobian (including laminar and turbulent) -- Gradients are formulated by following a diamond path
extern  void dFvdWf_Diamond(DenseMatrix &dFvdWf, DenseMatrix &dGvdWf, Flame2D_Quad_Block &SolnBlk, 
...
extern  void dWfdWc_Diamond(DenseMatrix &dWfdWc_x,DenseMatrix &dWfdWc_y, Flame2D_Quad_Block &SolnBlk, 
...
extern void d_dWd_dW_Diamond(double &d_dWdx_dW, double &d_dWdy_dW, Flame2D_Quad_Block &SolnBlk, 
...
extern void d_dWd_dW_Center(double &d_dWdx_dW_C, double &d_dWdy_dW_C, Flame2D_Quad_Block &SolnBlk, 
			    const int &i, const int &j);

/*****************************************************************************/
//Turbulence source Jacobian
extern int dS_tdW(DenseMatrix &dStdW,  Flame2D_Quad_Block &SolnBlk, double &d_dWdx_dW, double &d_dWdy_dW, const int &ii, const int &jj); 


//ARE THESE EVER CALLED ???

// extern int Automatic_Wall_Treatment_Residual_Jacobian(Flame2D_Quad_Block &SolnBlk, 
// 						      Flame2D_Input_Parameters &Input_Parameters, 
// 						      int i, int j, 
// 						      DenseMatrix &dRdU);

// extern int Wall_Function_Residual_Jacobian(Flame2D_Quad_Block &SolnBlk, 
// 					   Flame2D_Input_Parameters &Input_Parameters, 
// 					   int i, int j, 
// 					   DenseMatrix &dRdU);

// extern void Low_Reynoldsnumber_Formulation_Residual_Jacobian(Flame2D_Quad_Block &SolnBlk, 
// 							     Flame2D_Input_Parameters &Input_Parameters,
// 							     int i, int j, 
// 							     DenseMatrix &dRdU);

// extern void BC_Residual_Jacobian(Flame2D_Quad_Block &SolnBlk, 
// 				 Flame2D_Input_Parameters &Input_Parameters, 
// 				 int i, int j, 
// 				 DenseMatrix &dRdU);
