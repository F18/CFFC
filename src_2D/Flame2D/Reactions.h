...
inline void Reaction_set::omega(SOLN_cSTATE &U, const SOLN_pSTATE &W ) const{
  ...
  case CH4_1STEP: 
	...
	break;
      ...
      U.rhoc[index] = M[index]*ans*THOUSAND;  
    }
    break;
  ...
  case H2O2_2STEP:
    ...
    kf[0] = reactions[0].kf(Temp,W.c[0],W.c[1],W.c[4]);
    kb[0] = kf[0]/(reactions[0].keq(W,Temp));
    kf[1] = reactions[1].kf(Temp,W.c[0],W.c[1],W.c[4]);
...
inline void Reaction_set::dSwdU(DenseMatrix &dSwdU, const SOLN_pSTATE &W, 
  ...
  case H2O2_1STEP:  
    ...
    //-------------------------------------------
  case H2O2_2STEP:
    kf[0] = reactions[0].kf(Temp,c[0],c[1],W.c[4]);
    kb[0] = kf[0]/reactions[0].keq(W,Temp);
    kf[1] = reactions[1].kf(Temp,c[0],c[1],W.c[4]);
    kb[1] = kf[1]/reactions[1].keq(W,Temp);  
