...
C  END
C  SPECIES
C  H2   H    O2   OH   H2O  HO2  H2O2 CH3  CH4  CO   CO2  CH2O C2H2 C2H4 C2H6 NH3  
C  NO   HCN  N2                                                                    
C  END
C  REACTIONS
C  END
...
C
C
      SUBROUTINE CKWYP15STEP30(P, T, Y, WDOT)
...
C
      CALL THIRDB3( XM, XH2, XH, XO2, XOH, XH2O, XHO2, XH2O2, XCH3, XCH4,        
     &             XCO, XCO2, XCH2O, XC2H2, XC2H4, XC2H6, XNH3, XNO,            
     &             XHCN, XN2 )                                                  
C
C   SET THE ELEMENTARY RATES
C
      CALL ELEMRATE3( RF, RB, T, XM, TOLD )
C
...
C
      DO 40 K = 1, KSS
        ...
        LBOUND(K) = .TRUE.
 40   CONTINUE
      CALL UPVALUE3( 1, B, BIG, LBOUND, CONMAX, XNNH, XC2H, XCN, XCH3O,          
     ...
     &              XCH3CHO, XHCCO, XHCNO, XNCO, XNH, XHNO, XCH2CO )            
      ...
      DO 30 N = 1, NITER
          ...
          LITER = .TRUE.
          CONMAX = 0.0
        CALL STEADYE3( ABV, DEN, RF, RB, XM, ADJ, CONMAX, SMALL, LBOUND,
...
C
      CALL NETRATE3( W, RF, RB, XM, XH2, XH, XO, XO2, XOH, XH2O, XHO2,           
...
C N2                                                                            
      ...
      RETURN
      END
      SUBROUTINE THIRDB3( XM, XH2, XH, XO2, XOH, XH2O, XHO2, XH2O2, XCH3,        
...
C
     ...
     &          + 3.000*XC2H6+XNH3+XNO+XHCN+XN2                                 
      ...
      SUBROUTINE ELEMRATE3( RF, RB, T, XM, TOLD )
...
C   RATE CONSTANTS FOR SKELETAL MECHANSIM
     ...
     &          +( 5.57800D-09)*TP2+( 2.59563D-12)*TP3)                         
      ...
      SUBROUTINE STEADYE3( ABV, DEN, RF, RB, XM, ADJ, CONMX, SMALL,
...
C     STEADY-STATE EXPRESSION FOR CH2CO     
     ...
     &          RF(113)*XOH +RB(139) +RF(80)*XH +RF(79)*XH                      
      ...
      SUBROUTINE UPVALUE3( IOPT, VNEW, BIG, LBOUND, CONMAX, XNNH, XC2H,          
...
C*****END single precision
      ...
      ELSEIF( IOPT .EQ. 2 ) THEN
        CALL EXBOUND3( XNNH, VNEW(1), LBOUND(1),CONMAX,BIG)                      
        CALL EXBOUND3( XC2H, VNEW(2), LBOUND(2),CONMAX,BIG)                      
        CALL EXBOUND3( XCN, VNEW(3), LBOUND(3),CONMAX,BIG)                       
        CALL EXBOUND3( XCH3O, VNEW(4), LBOUND(4),CONMAX,BIG)                     
        CALL EXBOUND3( XHOCN, VNEW(5), LBOUND(5),CONMAX,BIG)                     
        CALL EXBOUND3( XCH2S, VNEW(6), LBOUND(6),CONMAX,BIG)                     
        CALL EXBOUND3( XNO2, VNEW(7), LBOUND(7),CONMAX,BIG)                      
        CALL EXBOUND3( XC2H5, VNEW(8), LBOUND(8),CONMAX,BIG)                     
        CALL EXBOUND3( XC3H8, VNEW(9), LBOUND(9),CONMAX,BIG)                     
        CALL EXBOUND3( XC3H7, VNEW(10), LBOUND(10),CONMAX,BIG)                   
        CALL EXBOUND3( XC2H3, VNEW(11), LBOUND(11),CONMAX,BIG)                   
        CALL EXBOUND3( XCH2CHO, VNEW(12), LBOUND(12),CONMAX,BIG)                 
        CALL EXBOUND3( XCH2OH, VNEW(13), LBOUND(13),CONMAX,BIG)                  
        CALL EXBOUND3( XHCO, VNEW(14), LBOUND(14),CONMAX,BIG)                    
        CALL EXBOUND3( XCH3OH, VNEW(15), LBOUND(15),CONMAX,BIG)                  
        CALL EXBOUND3( XHCCOH, VNEW(16), LBOUND(16),CONMAX,BIG)                  
        CALL EXBOUND3( XO, VNEW(17), LBOUND(17),CONMAX,BIG)                      
        CALL EXBOUND3( XN2O, VNEW(18), LBOUND(18),CONMAX,BIG)                    
        CALL EXBOUND3( XCH2, VNEW(19), LBOUND(19),CONMAX,BIG)                    
        CALL EXBOUND3( XHNCO, VNEW(20), LBOUND(20),CONMAX,BIG)                   
        CALL EXBOUND3( XNH2, VNEW(21), LBOUND(21),CONMAX,BIG)                    
        CALL EXBOUND3( XCH, VNEW(22), LBOUND(22),CONMAX,BIG)                     
        CALL EXBOUND3( XC, VNEW(23), LBOUND(23),CONMAX,BIG)                      
        CALL EXBOUND3( XN, VNEW(24), LBOUND(24),CONMAX,BIG)                      
        CALL EXBOUND3( XH2CN, VNEW(25), LBOUND(25),CONMAX,BIG)                   
        CALL EXBOUND3( XHCNN, VNEW(26), LBOUND(26),CONMAX,BIG)                   
        CALL EXBOUND3( XCH3CHO, VNEW(27), LBOUND(27),CONMAX,BIG)                 
        CALL EXBOUND3( XHCCO, VNEW(28), LBOUND(28),CONMAX,BIG)                   
        CALL EXBOUND3( XHCNO, VNEW(29), LBOUND(29),CONMAX,BIG)                   
        CALL EXBOUND3( XNCO, VNEW(30), LBOUND(30),CONMAX,BIG)                    
        CALL EXBOUND3( XNH, VNEW(31), LBOUND(31),CONMAX,BIG)                     
        CALL EXBOUND3( XHNO, VNEW(32), LBOUND(32),CONMAX,BIG)                    
        CALL EXBOUND3( XCH2CO, VNEW(33), LBOUND(33),CONMAX,BIG)                  
      ...
      SUBROUTINE EXBOUND3( VOLD, B, LBOUND, CONMAX, BIG )
...
C*****END single precision
      ...
      SUBROUTINE NETRATE3( W, RF, RB, XM, XH2, XH, XO, XO2, XOH, XH2O,           
