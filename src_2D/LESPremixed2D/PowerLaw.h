/****************** PowerLaw.h **************************************
  This class defines the subgrid scale model for the turbulent flame
...
#define   CK         1.5      // Kolmogorov constant
#define   C_sfs_rms  1.545    // Model constant for the SFS root 
                     /*2D*/   // mean square velocity. 
...
public:
  ...
  double TF;             //!< Thickening factor.

  static int n;          //!< Number of cells across the flame front                
  
  // constructors
  PowerLaw() : WF(1.0), TF(1.0) { }
