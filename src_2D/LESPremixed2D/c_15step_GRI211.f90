!     Complexified version of the subroutine CKWY15STEP211(P, T, Y, WDOT, WW)
!
      SUBROUTINE CPLX15STEP211(P, T, Y, WDOT)
...
!                   Dimension Y(*) at least 19, the total number of
!                   species.
!     Y(1)=   H2
!     Y(2)=   H
!     Y(3)=   O2
...
!     Y(19)=  N2
!
!     ICKWRK - Dummy Array of integer workspace.
!                   Data type - integer array
!              (Not used - simply to be compatible with Chemkin)
!     RCKWRK - Dummy Array of real work space.
!                   Data type - real array
!              (Not used - simply to be compatible with Chemkin)
!
!  OUTPUT
...
!*****double precision
	use complexify 
        IMPLICIT complex*16 (A-H, O-Z), INTEGER (I-N)
...
!
      ...
      ENDDO
!
!   SET LOCAL VALUES FOR THE CONCENTRATIONS
!
...
!
      CALL CPLXTHIRDB( XM, XH2, XH, XO2, XOH, XH2O, XHO2, XH2O2, XCH3, XCH4, &
                   XCO, XCO2, XCH2O, XC2H2, XC2H4, XC2H6, XNH3, XNO, &
                   XHCN, XN2 )
!
!   SET THE ELEMENTARY RATES
!
      CALL CPLXELEMRATE( RF, RB, T, XM, TOLD )
!
!   EXPRESSIONS FOR STEADY-STATE SPECIES
!
      DO 40 K = 1, KSS
        B(K) = 0.0
        LBOUND(K) = .TRUE.
 40   CONTINUE
      CALL CPLXUPVALUE( 1, B, BIG, LBOUND, CONMAX, XNNH, XC2H, XCN, XHOCN, &
      ...
      DO 30 N = 1, NITER
          ...
          LITER = .TRUE.
          CONMAX = 0.0
        CALL CPLXSTEADYE( ABV, DEN, RF, RB, XM, ADJ, CONMAX, SMALL, LBOUND, &
        ...
        IF( LITER .AND. CONMAX < 1.0D-5 ) GO TO 35
 ...
 35   CONTINUE
!
!   NET PRODUCTION RATES FOR SKELETAL MECHANISM
!
      CALL CPLXNETRATE( W, RF, RB, XM, XH2, XH, XO, XO2, XOH, XH2O, XHO2, &
                    ...
                    XN2 )
!
!   GLOBAL RATES FOR REDUCED MECHANISM
!
...
!  HO2 =  0.50 O2 + OH
!   0.50 O2 + H2O2 = OH + HO2
!   0.50 O2 +  0.50 C2H2 = H + CO
!  CH3 + CO + C2H4 =  0.50 O2 + CH4 +  1.50 C2H2
!   0.50 O2 +  2CH3 = H2 + CH4 + CO
!   0.50 O2 + CH3 = H + CH2O
!   0.50 O2 + CH4 = OH + CH3
!   0.50 O2 + CO = CO2
!   0.50 O2 + C2H6 = CH4 + CH2O
!  H + OH = H2O
!  H + CH4 + NO + HCN =  0.50 O2 +  2CH3 + N2
!  H +  0.50 O2 + CH4 + HCN =  2CH3 + NO
!   0.50 O2 + CH4 + NH3 + HCN = H2O +  2CH3 + N2
!
...
! N2
      ...
      DO K = 1, KK
        IF( XCON(K) .LE. 0.D0 .AND. WDOT(K) < 0.D0 ) WDOT(K) = 0.D0
      END DO

      RETURN
      END
      SUBROUTINE CPLXTHIRDB( XM, XH2, XH, XO2, XOH, XH2O, XHO2, XH2O2, XCH3, &
...
!
      ...
      SUBROUTINE CPLXELEMRATE( RF, RB, T, XM, TOLD )
...
!   RATE CONSTANTS FOR SKELETAL MECHANSIM
      ...
      SUBROUTINE CPLXSTEADYE( ABV, DEN, RF, RB, XM, ADJ, CONMX, SMALL, &
...
!     STEADY-STATE EXPRESSION FOR NNH
      ...
      IF(DEN(1) < 1.0) DEN(1) = MAX( ADJ*ABV(1), DEN(1), SMALL )
      VOLD = XNNH
      XNNH = ABV(1)/DEN(1)
...
!     STEADY-STATE EXPRESSION FOR C2H
      ...
      IF(DEN(2) < 1.0) DEN(2) = MAX( ADJ*ABV(2), DEN(2), SMALL )
      VOLD = XC2H
      XC2H = ABV(2)/DEN(2)
...
!     STEADY-STATE EXPRESSION FOR CN
      ...
      IF(DEN(3) < 1.0) DEN(3) = MAX( ADJ*ABV(3), DEN(3), SMALL )
      VOLD = XCN
      XCN = ABV(3)/DEN(3)
...
!     STEADY-STATE EXPRESSION FOR HNO
      ...
      IF(DEN(5) < 1.0) DEN(5) = MAX( ADJ*ABV(5), DEN(5), SMALL )
      VOLD = XHNO
      XHNO = ABV(5)/DEN(5)
...
!     STEADY-STATE EXPRESSION FOR C2H5
      ...
      IF(DEN(7) < 1.0) DEN(7) = MAX( ADJ*ABV(7), DEN(7), SMALL )
      VOLD = XC2H5
      XC2H5 = ABV(7)/DEN(7)
...
!     STEADY-STATE EXPRESSION FOR CH2S
      ...
      IF(DEN(8) < 1.0) DEN(8) = MAX( ADJ*ABV(8), DEN(8), SMALL )
      VOLD = XCH2S
      XCH2S = ABV(8)/DEN(8)
...
!     STEADY-STATE EXPRESSION FOR C2H3
      ...
      IF(DEN(9) < 1.0) DEN(9) = MAX( ADJ*ABV(9), DEN(9), SMALL )
      VOLD = XC2H3
      XC2H3 = ABV(9)/DEN(9)
...
!     STEADY-STATE EXPRESSION FOR CH2OH
      ...
      IF(DEN(10) < 1.0) DEN(10) = MAX( ADJ*ABV(10), DEN(10), SMALL )
      VOLD = XCH2OH
...
!     STEADY-STATE EXPRESSION FOR CH2
      ...
      IF(DEN(11) < 1.0) DEN(11) = MAX( ADJ*ABV(11), DEN(11), SMALL )
      VOLD = XCH2
      ACH2 = RF(136)
...
!     STEADY-STATE EXPRESSION FOR HNCO
      ...
      IF(DEN(12) < 1.0) DEN(12) = MAX( ADJ*ABV(12), DEN(12), SMALL )
      VOLD = XHNCO
      XHNCO = ABV(12)/DEN(12)
...
!     STEADY-STATE EXPRESSION FOR NH2
      ...
      IF(DEN(13) < 1.0) DEN(13) = MAX( ADJ*ABV(13), DEN(13), SMALL )
      VOLD = XNH2
      XNH2 = ABV(13)/DEN(13)
...
!     STEADY-STATE EXPRESSION FOR CH
      ...
      IF(DEN(14) < 1.0) DEN(14) = MAX( ADJ*ABV(14), DEN(14), SMALL )
      VOLD = XCH
      XCH = ABV(14)/DEN(14)
...
!     STEADY-STATE EXPRESSION FOR C
      ...
      IF(DEN(15) < 1.0) DEN(15) = MAX( ADJ*ABV(15), DEN(15), SMALL )
      VOLD = XC
      XC = ABV(15)/DEN(15)
...
!     STEADY-STATE EXPRESSION FOR N
      ...
      IF(DEN(16) < 1.0) DEN(16) = MAX( ADJ*ABV(16), DEN(16), SMALL )
      VOLD = XN
      XN = ABV(16)/DEN(16)
...
!     STEADY-STATE EXPRESSION FOR H2CN
      ...
      IF(DEN(17) < 1.0) DEN(17) = MAX( ADJ*ABV(17), DEN(17), SMALL )
      VOLD = XH2CN
      XH2CN = ABV(17)/DEN(17)
...
!     STEADY-STATE EXPRESSION FOR HCNN
      ...
      IF(DEN(18) < 1.0) DEN(18) = MAX( ADJ*ABV(18), DEN(18), SMALL )
      VOLD = XHCNN
      XHCNN = ABV(18)/DEN(18)
...
!     STEADY-STATE EXPRESSION FOR HCNO
      ...
      IF(DEN(19) < 1.0) DEN(19) = MAX( ADJ*ABV(19), DEN(19), SMALL )
      VOLD = XHCNO
      XHCNO = ABV(19)/DEN(19)
...
!     STEADY-STATE EXPRESSION FOR HCO
      ...
      IF(DEN(20) < 1.0) DEN(20) = MAX( ADJ*ABV(20), DEN(20), SMALL )
      VOLD = XHCO
      XHCO = ABV(20)/DEN(20)
...
!     STEADY-STATE EXPRESSION FOR CH3OH
      ...
      IF(DEN(21) < 1.0) DEN(21) = MAX( ADJ*ABV(21), DEN(21), SMALL )
      VOLD = XCH3OH
...
!     STEADY-STATE EXPRESSION FOR CH3O
      ...
      IF(DEN(22) < 1.0) DEN(22) = MAX( ADJ*ABV(22), DEN(22), SMALL )
      VOLD = XCH3O
      XCH3O = ABV(22)/DEN(22)
...
!     STEADY-STATE EXPRESSION FOR O
      ...
      IF(DEN(23) < 1.0) DEN(23) = MAX( ADJ*ABV(23), DEN(23), SMALL )
      VOLD = XO
      AO = RF(1)*XM(1)
      BO = DEN(23) - AO*XO
      ZO = ABV(23)/BO
...
!     STEADY-STATE EXPRESSION FOR N2O
      ...
      IF(DEN(24) < 1.0) DEN(24) = MAX( ADJ*ABV(24), DEN(24), SMALL )
      VOLD = XN2O
      XN2O = ABV(24)/DEN(24)
...
!     STEADY-STATE EXPRESSION FOR HCCO
      ...
      IF(DEN(25) < 1.0) DEN(25) = MAX( ADJ*ABV(25), DEN(25), SMALL )
      VOLD = XHCCO
      AHCCO = RF(175)
...
!     STEADY-STATE EXPRESSION FOR NCO
      ...
      IF(DEN(26) < 1.0) DEN(26) = MAX( ADJ*ABV(26), DEN(26), SMALL )
      VOLD = XNCO
      XNCO = ABV(26)/DEN(26)
...
!     STEADY-STATE EXPRESSION FOR NH
      ...
      IF(DEN(27) < 1.0) DEN(27) = MAX( ADJ*ABV(27), DEN(27), SMALL )
      VOLD = XNH
      XNH = ABV(27)/DEN(27)
...
!     STEADY-STATE EXPRESSION FOR NO2
      ...
      IF(DEN(28) < 1.0) DEN(28) = MAX( ADJ*ABV(28), DEN(28), SMALL )
      VOLD = XNO2
      XNO2 = ABV(28)/DEN(28)
...
!     STEADY-STATE EXPRESSION FOR CH2CO
      ...
      IF(DEN(29) < 1.0) DEN(29) = MAX( ADJ*ABV(29), DEN(29), SMALL )
      VOLD = XCH2CO
      ...
      SUBROUTINE CPLXUPVALUE( IOPT, VNEW, BIG, LBOUND, CONMAX, XNNH, XC2H, &
...
!*****END single precision
      ...
      IF( IOPT .ceq. 1 ) THEN
        ...
        XNO2 = VNEW(28)
        XCH2CO = VNEW(29)
      ELSEIF( IOPT .ceq. 2 ) THEN
        CALL CPLXEXBOUND( XNNH, VNEW(1), LBOUND(1), CONMAX, BIG )
        CALL CPLXEXBOUND( XC2H, VNEW(2), LBOUND(2), CONMAX, BIG )
        CALL CPLXEXBOUND( XCN, VNEW(3), LBOUND(3), CONMAX, BIG )
        CALL CPLXEXBOUND( XHOCN, VNEW(4), LBOUND(4), CONMAX, BIG )
        CALL CPLXEXBOUND( XHNO, VNEW(5), LBOUND(5), CONMAX, BIG )
        CALL CPLXEXBOUND( XHCCOH, VNEW(6), LBOUND(6), CONMAX, BIG )
        CALL CPLXEXBOUND( XC2H5, VNEW(7), LBOUND(7), CONMAX, BIG )
        CALL CPLXEXBOUND( XCH2S, VNEW(8), LBOUND(8), CONMAX, BIG )
        CALL CPLXEXBOUND( XC2H3, VNEW(9), LBOUND(9), CONMAX, BIG )
        CALL CPLXEXBOUND( XCH2OH, VNEW(10), LBOUND(10), CONMAX, BIG )
        CALL CPLXEXBOUND( XCH2, VNEW(11), LBOUND(11), CONMAX, BIG )
        CALL CPLXEXBOUND( XHNCO, VNEW(12), LBOUND(12), CONMAX, BIG )
        CALL CPLXEXBOUND( XNH2, VNEW(13), LBOUND(13), CONMAX, BIG )
        CALL CPLXEXBOUND( XCH, VNEW(14), LBOUND(14), CONMAX, BIG )
        CALL CPLXEXBOUND( XC, VNEW(15), LBOUND(15), CONMAX, BIG )
        CALL CPLXEXBOUND( XN, VNEW(16), LBOUND(16), CONMAX, BIG )
        CALL CPLXEXBOUND( XH2CN, VNEW(17), LBOUND(17), CONMAX, BIG )
        CALL CPLXEXBOUND( XHCNN, VNEW(18), LBOUND(18), CONMAX, BIG )
        CALL CPLXEXBOUND( XHCNO, VNEW(19), LBOUND(19), CONMAX, BIG )
        CALL CPLXEXBOUND( XHCO, VNEW(20), LBOUND(20), CONMAX, BIG )
        CALL CPLXEXBOUND( XCH3OH, VNEW(21), LBOUND(21), CONMAX, BIG )
        CALL CPLXEXBOUND( XCH3O, VNEW(22), LBOUND(22), CONMAX, BIG )
        CALL CPLXEXBOUND( XO, VNEW(23), LBOUND(23), CONMAX, BIG )
        CALL CPLXEXBOUND( XN2O, VNEW(24), LBOUND(24), CONMAX, BIG )
        CALL CPLXEXBOUND( XHCCO, VNEW(25), LBOUND(25), CONMAX, BIG )
        CALL CPLXEXBOUND( XNCO, VNEW(26), LBOUND(26), CONMAX, BIG )
        CALL CPLXEXBOUND( XNH, VNEW(27), LBOUND(27), CONMAX, BIG )
        CALL CPLXEXBOUND( XNO2, VNEW(28), LBOUND(28), CONMAX, BIG )
        CALL CPLXEXBOUND( XCH2CO, VNEW(29), LBOUND(29), CONMAX, BIG )
      ELSEIF( IOPT .ceq. 3 ) THEN
        VNEW(1) = XNNH
        VNEW(2) = XC2H
        VNEW(3) = XCN
        VNEW(4) = XHOCN
      ...
      SUBROUTINE CPLXEXBOUND( VOLD, B, LBOUND, CONMAX, BIG )
...
!*****END single precision
      ...
      SUBROUTINE CPLXNETRATE( W, RF, RB, XM, XH2, XH, XO, XO2, XOH, XH2O, &
                         XHO2, XH2O2, XC, XCH, XCH2, XCH2S, XCH3, XCH4, &
                         XCO, XCO2, XHCO, XCH2O, XCH2OH, XCH3O, XCH3OH, &
                         XC2H, XC2H2, XC2H3, XC2H4, XC2H5, XC2H6, &
                         XHCCO, XCH2CO, XHCCOH, XN, XNH, XNH2, XNH3, &
...
!   NET PRODUCTION RATES FOR SKELETAL MECHANSIM
