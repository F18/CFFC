/**********************************************************************
 * Dusty2DQuadIOMultiBlock.cc                                         *
 *                                                                    *
 * Multi-block versions of input and output subroutines for 2D Dusty  *
 ...
 *                                                                    *
 **********************************************************************/
int Read_Restart_Solution(Dusty2D_Quad_Block *Soln_ptr,
  ...
  for (int nb = 0; nb < Soln_Block_List.Nblk; nb++) {
    if (Soln_Block_List.Block[nb].used == ADAPTIVEBLOCK2D_USED) {
      ...
      //restart_file.getline(gas_type,sizeof(gas_type));
      //restart_file.getline(solid_type,sizeof(particle_type));
      if (!i_new_time_set) {
	...
	//IP.Wo.setsolid(IP.Solid_Type);
	//IP.Uo.setgas(IP.Gas_Type);
	//IP.Uo.setsolid(IP.Solid_Type);
	//IP.Uo = U(IP.Wo);
	//}
	i_new_time_set = 1;
      }
 ...
 *                                                                    *
 **********************************************************************/
int Write_Restart_Solution(Dusty2D_Quad_Block *Soln_ptr,
                           AdaptiveBlock2D_List &Soln_Block_List,
                           Dusty2D_Input_Parameters &IP,
 ...
 *                                                                    *
 **********************************************************************/
int Output_Tecplot(Dusty2D_Quad_Block *Soln_ptr,
                   AdaptiveBlock2D_List &Soln_Block_List,
                   Dusty2D_Input_Parameters &IP,
                   const int Number_of_Time_Steps,
                   const double &Time) {
 ...
 *                                                                    *
 **********************************************************************/
int Output_Cells_Tecplot(Dusty2D_Quad_Block *Soln_ptr,
                         AdaptiveBlock2D_List &Soln_Block_List,
                         Dusty2D_Input_Parameters &IP,
                         const int Number_of_Time_Steps,
                         const double &Time) {
 ...
 *                                                                    *
 **********************************************************************/
int Output_Nodes_Tecplot(Dusty2D_Quad_Block *Soln_ptr,
			 AdaptiveBlock2D_List &Soln_Block_List,
			 Dusty2D_Input_Parameters &IP,
			 const int Number_of_Time_Steps,
			 const double &Time) {
 ...
 *                                                                    *
 **********************************************************************/
int Output_Gradients_Tecplot(Dusty2D_Quad_Block *Soln_ptr,
			     AdaptiveBlock2D_List &Soln_Block_List,
			     Dusty2D_Input_Parameters &IP,
			     const int Number_of_Time_Steps,
			     const double &Time) {
 ...
 *                                                                    *
 **********************************************************************/
int Output_Quasi3D_Tecplot(Dusty2D_Quad_Block *Soln_ptr,
			   AdaptiveBlock2D_List &Soln_Block_List,
			   Dusty2D_Input_Parameters &IP,
			   const int Number_of_Time_Steps,
			   const double &Time) {
 ...
 *                                                                    *
 **********************************************************************/
int Output_Mesh_Tecplot(Dusty2D_Quad_Block *Soln_ptr,
                        AdaptiveBlock2D_List &Soln_Block_List,
                        Dusty2D_Input_Parameters &IP,
                        const int Number_of_Time_Steps,
                        const double &Time) {
 ...
 *                                                                    *
 **********************************************************************/
int Output_Mesh_Gnuplot(Dusty2D_Quad_Block *Soln_ptr,
                        AdaptiveBlock2D_List &Soln_Block_List,
                        Dusty2D_Input_Parameters &IP,
                        const int Number_of_Time_Steps,
                        const double &Time) {
 ...
 *                                                                    *
 **********************************************************************/
int Output_Ringleb(Dusty2D_Quad_Block *Soln_ptr,
		   AdaptiveBlock2D_List &Soln_Block_List,
		   Dusty2D_Input_Parameters &IP) {
  ...
  // L1, L2, and Max norms of the error and the number of active cells.
  i_output_title = 1;
  l1_norm = ZERO; l2_norm = ZERO; max_norm = ZERO; area = ZERO;
  for (int nb = 0; nb < Soln_Block_List.Nblk; nb++) {
    if (Soln_Block_List.Block[nb].used == ADAPTIVEBLOCK2D_USED) {
      l1_temp = ZERO; l2_temp = ZERO; max_temp = ZERO; area_temp = ZERO;
      Output_Ringleb(Soln_ptr[nb],nb,i_output_title,output_file,
 ...
 *                                                                    *
 **********************************************************************/
int Output_Viscous_Channel(Dusty2D_Quad_Block *Soln_ptr,
			   AdaptiveBlock2D_List &Soln_Block_List,
			   Dusty2D_Input_Parameters &IP) {
  ...
  for (int nb = 0; nb < Soln_Block_List.Nblk; nb++) {
    if (Soln_Block_List.Block[nb].used == ADAPTIVEBLOCK2D_USED) {
      ...
      l2_norm += sqr(l2_temp);
      max_norm = max(max_norm,max_temp);
      numberofactivecells_temp = (Soln_ptr[nb].Grid.NCi-2*Soln_ptr[nb].Nghost)*
 ...
 *                                                                    *
 **********************************************************************/
int Output_Viscous_Pipe(Dusty2D_Quad_Block *Soln_ptr,
			AdaptiveBlock2D_List &Soln_Block_List,
			Dusty2D_Input_Parameters &IP) {
  ...
  for (int nb = 0; nb < Soln_Block_List.Nblk; nb++) {
    if (Soln_Block_List.Block[nb].used == ADAPTIVEBLOCK2D_USED) {
      l1_temp = ZERO; l2_temp = ZERO; max_temp = ZERO;
      Output_Viscous_Pipe(Soln_ptr[nb],nb,i_output_title,output_file,
 ...
 *                                                                    *
 **********************************************************************/
int Output_Turbulent_Pipe_Tecplot(Dusty2D_Quad_Block *Soln_ptr,
				  AdaptiveBlock2D_List &Soln_Block_List,
				  Dusty2D_Input_Parameters &IP) {
 ...
 *                                                                    *
 **********************************************************************/
int Output_Flat_Plate(Dusty2D_Quad_Block *Soln_ptr,
		      AdaptiveBlock2D_List &Soln_Block_List,
		      Dusty2D_Input_Parameters &IP) {
 ...
 *                                                                    *
 **********************************************************************/
int Output_Driven_Cavity_Flow(Dusty2D_Quad_Block *Soln_ptr,
			      AdaptiveBlock2D_List &Soln_Block_List,
			      Dusty2D_Input_Parameters &IP) {
