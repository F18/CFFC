/**********************************************************************
 * Dusty2DQuadTurbulenceSingleBlock.cc: Single-block versions of      *
 *                                      turbulence subroutines for    *
 *                                      the 2D Dusty multi-block      *
 ...
 *                                                                    *
 **********************************************************************/
int Turbulence_ICs(Dusty2D_Quad_Block &SolnBlk,
 ...
 *                                                                    *
 **********************************************************************/
int Turbulence_BCs(Dusty2D_Quad_Block &SolnBlk,
		   Dusty2D_Input_Parameters &IP) {
...
/**********************************************************************
 **********************************************************************/
int Apply_Turbulence_BCs(Dusty2D_Quad_Block &SolnBlk,
			 Dusty2D_Input_Parameters &IP,
 ...
 *                                                                    *
 **********************************************************************/
int Turbulence_Zero_Residual(Dusty2D_Quad_Block &SolnBlk,
                             const int i_stage,
			     Dusty2D_Input_Parameters &IP) {
...
/**********************************************************************
 **********************************************************************/
int Zero_Turbulence_Residuals(Dusty2D_Quad_Block &SolnBlk,
			      Dusty2D_Input_Parameters &IP,
			      const int &Turbulent_BCtype,
			      const int &i, const int &j,
