...
namespace tut
{
  ...
  class Data_'NAME' : public TestData {
   ...
   */
  typedef test_group<Data_'NAME'> 'NAME'_TestSuite;
  typedef 'NAME'_TestSuite::object 'NAME'_object;
...
tut::'NAME'_TestSuite 'NAME'TestSuite("Test Suite Name");
