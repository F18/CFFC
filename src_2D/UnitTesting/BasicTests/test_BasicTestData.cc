...
namespace tut
{
  ...
  void object::test<2>()
  {
    ...
    try {
      ...
      char * output_stream_file_name = "UnitTesting/BasicTests/BasicTestData_Test";
  ...
  void object::test<3>()
  {
    ...
    try {
      ofstream output_stream;
      char * output_stream_file_name = "UnitTesting/BasicTests/FailureTest";
      open_output_stream(output_stream,output_stream_file_name);
  ...
  void object::test<4>()
  {
    ...
    try {
      ...
      char * input_stream_file_name = "UnitTesting/BasicTests/BasicTestData_Test";
  ...
  void object::test<5>()
  {
    ...
    try {
      ifstream input_stream;
      char * input_stream_file_name = "UnitTesting/BasicTests/FailureTest";
      open_input_stream(input_stream,input_stream_file_name);
...
tut::TestGroup BasicTestData("TestData_Class");
