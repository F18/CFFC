/*!\file Euler2DHighOrder.h
  \brief Header file defining specializations of HighOrder2D template class for Euler2D solution states. */

#ifndef _EULER2D_HIGHORDER_SPECIALIZATION_INCLUDED
#define _EULER2D_HIGHORDER_SPECIALIZATION_INCLUDED
...
template<>
template<> inline
void HighOrder2D<Euler2D_pState>::
Generalized_RelationalConstraints_Equations(Euler2D_Quad_Block & SolnBlk,
...
#endif	// _EULER2D_HIGHORDER_SPECIALIZATION_INCLUDED
