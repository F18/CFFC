...
class Rte2DQuadSolver {
 ...
 public:
   ...
   ********************************************************/
  int SetDefaultInputs();
  int SetupMesh();
  int SetICs();
  int InitialBroadCast();
  int BCs();
  int AMR();
  int MortonOrdering();
  int SolveTimeStep();
 ...
 ********************************************************/
inline int Rte2DQuadSolver::SetDefaultInputs() {
...
inline int Rte2DQuadSolver::SetupMesh() {
...
inline int Rte2DQuadSolver::SetICs() {
...
inline int Rte2DQuadSolver::InitialBroadCast() {
...
inline int Rte2DQuadSolver::SetBCs() {
...
inline int Rte2DQuadSolver::PerformAMR() {
...
inline int Rte2DQuadSolver::PerformMortonOrdering() {
...
inline int Rte2DQuadSolver::SolveMultigrid() {
...
inline int Rte2DQuadSolver::SolveSpaceMarch() {
...
inline int Rte2DQuadSolver::SolveTimeStepping() {
...
inline int Rte2DQuadSolver::SolveNKS() {
...
inline int Rte2DQuadSolver::PostPRocess() {
