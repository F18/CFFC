/**************************************************************** 
   ...
   2D Axisymmetric Solver for.... This file defines the member
   functions of the class 'Rte2DSolver' which encapsulates 
   the main Rte2D solver.  It can be called in full standalone 
   mode (ie. by itself), or in sequential solve mode (ie. say 
   from Chem2D).
 ...
 ********************************************************/
int Rte2DSolver::StandAloneSolve(const int batch_flag_, 
 ...
 ********************************************************/
int Rte2DSolver::ReadInputFile(char *Input_File_Name_ptr, 
			       int &command_flag) {
 ...
 *                                                      *
 ********************************************************/
int Rte2DSolver::CopyMesh(Grid2D_Quad_Block **SRC_MeshBlk) {
  ...
  if (CFFC_Primary_MPI_Processor()) {
    ...
    MeshBlk = Copy_Multi_Block_Grid(SRC_MeshBlk,
				    Input_Parameters.Number_of_Blocks_Idir,
				    Input_Parameters.Number_of_Blocks_Jdir);
 ...
 ********************************************************/
int Rte2DSolver::BroadcastSolution() {
 ...
 * refinement.                                          *
 ********************************************************/
int Rte2DSolver::PerformPeriodicAMR() {
 ...
 ********************************************************/
int Rte2DSolver::PerformMortonOrdering() {
 ...
 * processors.                                          *
 ********************************************************/
int Rte2DSolver::PerformMortonReOrdering() {
 ...
 ********************************************************/
int Rte2DSolver::OpenResidualFile(ofstream &residual_file) {
 ...
 ********************************************************/
void Rte2DSolver::OutputProgress(const double residual_l1_norm, 
 ...
 ********************************************************/
void Rte2DSolver::ComputeNorms(double &residual_l1_norm, 
 ...
 ********************************************************/
int Rte2DSolver::WritePeriodicRestart() {
 ...
 ****************************************************************************
 ****************************************************************************/  
int Rte2DSolver::SolveMultigrid() {
 ...
 ****************************************************************************
 ****************************************************************************/  
int Rte2DSolver::SolveSpaceMarch() {
 ...
 ****************************************************************************
 ****************************************************************************/  
int Rte2DSolver::SolveExplicitTimeStep() {
 ...
 *************************************************************************** 
 ****************************************************************************/ 
int Rte2DSolver::PostProcess(int &command_flag) {
