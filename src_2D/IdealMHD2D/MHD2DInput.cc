/*!\file MHD2DInput.cc
  \brief Subroutines for 2D MHD Input Classes. */
...
#include "MHD2DInput.h" /* Include 2D MHD input parameter header file. */
//#include "MHD2DQuad.h"  /* Include MHD2D_Quad_Block header file. */
...
/*****************************************************
 * MHD2D_Input_Parameters -- Member functions.     *
 ****************************************************/
 ...
 */
bool MHD2D_Input_Parameters::OutputBoundaryReferenceState(const int & BCtype) const{
 ...
 ********************************************************/
int MHD2D_Input_Parameters::Parse_Input_File(char *Input_File_Name_ptr){
  ...
  if (Input_File.fail()) {
    msg << "MHD2D_Input_Parameters::Parse_Input_File() ERROR: Unable to open "
  ...
  while (1) {
    ...
    if (command_flag == EXECUTE_CODE) {
      ...
      msg << "MHD2D_Input_Parameters::Parse_Input_File() ERROR: Error reading data at line # " 
	  << -Line_Number
	  << " of input data file.";
      if (Verbose()){
	cerr << msg.str() << endl;
 ...
 ********************************************************/
void MHD2D_Input_Parameters::Get_Next_Input_Control_Parameter(void){
 ...
 ********************************************************/
void MHD2D_Input_Parameters::doInternalSetupAndConsistencyChecks(int & error_flag){

  /* Perform consistency checks on input parameters for multigrid */
  if (!error_flag &&
      i_Time_Integration == TIME_STEPPING_MULTIGRID) {
    error_flag = Check_Input_Parameters<MHD2D_Input_Parameters>(*this);
    if (error_flag) {
      cout << "\n MHD2D ERROR: Input Parameters consistency check failure\n";
    }
  }
  ...
  Wo = MHD3D_pState(Pressure/Temperature, 
		    ZERO, ZERO, 
		    ZERO, ZERO,
		    Pressure);
  Wo.vx() = Mach_Number*Wo.a()*cos(TWO*PI*
				   Flow_Angle/360.00);
  Wo.vy() = Mach_Number*Wo.a()*sin(TWO*PI*
				   Flow_Angle/360.00);
  ...
  TurnOff(
  // Set reference state in the MHD2D_Quad_Block class
  MHD2D_Quad_Block::Set_Normalization_Reference_State(RefW);
	  )
...
/*************************************************************
 * MHD2D_Input_Parameters -- External subroutines.         *
 *************************************************************/
 ...
 *                                                      
 ********************************************************/
void Open_Input_File(MHD2D_Input_Parameters &IP) {
 ...
 *                                                      
 ********************************************************/
void Close_Input_File(MHD2D_Input_Parameters &IP) {
 ...
 *                                                     
 ********************************************************/
void Set_Default_Input_Parameters(MHD2D_Input_Parameters &IP) {
    ...
    IP.Wo = MHD3D_pState::MHD3D_W_REF;
    IP.Pressure = IP.Wo.p();
    IP.Temperature = IP.Wo.T();
    IP.Mach_Number = 0.80;
    IP.Flow_Angle = ZERO;
    IP.Wo.vx() = IP.Mach_Number*IP.Wo.a()*cos(TWO*PI*IP.Flow_Angle/360.00);
    IP.Wo.vy() = IP.Mach_Number*IP.Wo.a()*sin(TWO*PI*IP.Flow_Angle/360.00);
    ...
    IP.BC_East  = BC_NONE;
    IP.BC_West  = BC_NONE;
    IP.Ref_State_BC_North = MHD3D_pState(0.0);
    IP.Ref_State_BC_South = MHD3D_pState(0.0);
    IP.Ref_State_BC_East = MHD3D_pState(0.0);
    IP.Ref_State_BC_West = MHD3D_pState(0.0);
 ...
 *                                                      
 ********************************************************/
void Broadcast_Input_Parameters(MHD2D_Input_Parameters &IP) {
    ...
    if (!CFFC_Primary_MPI_Processor()) {
       IP.Wo.setgas(IP.Gas_Type);
       IP.Wo = MHD3D_pState(IP.Pressure/IP.Temperature, 
			    ZERO, ZERO, 
			    ZERO, ZERO,
			    IP.Pressure);
       IP.Wo.vx() = IP.Mach_Number*IP.Wo.a()*cos(TWO*PI*IP.Flow_Angle/360.00);
    ...
    MPI::COMM_WORLD.Bcast(&(IP.W1.d()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W1.vx()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W1.vy()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W1.vz()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W1.B1x()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W1.B1y()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W1.B1z()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W1.B0x()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W1.B0y()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W1.B0z()), 
                          1, 
                          MPI::DOUBLE, 0);
    ...
    MPI::COMM_WORLD.Bcast(&(IP.W2.d()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W2.vx()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W2.vy()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W2.vz()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W2.B1x()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W2.B1y()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W2.B1z()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W2.B0x()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W2.B0y()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W2.B0z()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.W2.p()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.d()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.vx()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.vy()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.vz()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.B1x()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.B1y()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.B1z()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.B0x()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.B0y()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.B0z()), 
                          1, 
                          MPI::DOUBLE, 0);
    MPI::COMM_WORLD.Bcast(&(IP.RefW.p()), 
                          1, 
                          MPI::DOUBLE, 0);
    ...
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_North.d()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_North.vx()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_North.vy()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_North.vz()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_North.B1x()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_North.B1y()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_North.B1z()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_North.B0x()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_North.B0y()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_North.B0z()),
			  1,
			  MPI::DOUBLE,0);
    ...
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_South.d()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_South.vx()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_South.vy()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_South.vz()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_South.B1x()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_South.B1y()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_South.B1z()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_South.B0x()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_South.B0y()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_South.B0z()),
			  1,
			  MPI::DOUBLE,0);
    ...
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_East.d()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_East.vx()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_East.vy()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_East.vz()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_East.B1x()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_East.B1y()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_East.B1z()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_East.B0x()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_East.B0y()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_East.B0z()),
			  1,
			  MPI::DOUBLE,0);
    ...
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_West.d()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_West.vx()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_West.vy()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_West.vz()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_West.B1x()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_West.B1y()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_West.B1z()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_West.B0x()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_West.B0y()),
			  1,
			  MPI::DOUBLE,0);
    MPI::COMM_WORLD.Bcast(&(IP.Ref_State_BC_West.B0z()),
			  1,
			  MPI::DOUBLE,0);
    ...
    if (!CFFC_Primary_MPI_Processor()) {
       ...
       for (i = 0; i < 3; i++) {
          IP.ICEMCFD_FileNames[i] = new char[INPUT_PARAMETER_LENGTH_MHD2D];
       } /* endfor */
    } /* endif */
    ...
    if (!CFFC_Primary_MPI_Processor()) {
      TurnOff(
      // Set reference state in the MHD2D_Quad_Block class
      MHD2D_Quad_Block::Set_Normalization_Reference_State(IP.RefW);
	      )
    }
...
void Broadcast_Input_Parameters(MHD2D_Input_Parameters &IP,
    ...
    Communicator.Bcast(&(IP.W1.d()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W1.vx()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W1.vy()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W1.vz()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W1.B1x()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W1.B1y()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W1.B1z()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W1.B0x()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W1.B0y()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W1.B0z()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    ...
    Communicator.Bcast(&(IP.W2.d()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W2.vx()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W2.vy()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W2.vz()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W2.B1x()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W2.B1y()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W2.B1z()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W2.B0x()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W2.B0y()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W2.B0z()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.W2.p()), 
                       1, 
                       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.d()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.vx()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.vy()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.vz()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.B1x()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.B1y()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.B1z()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.B0x()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.B0y()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.B0z()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    Communicator.Bcast(&(IP.RefW.p()), 
		       1, 
		       MPI::DOUBLE, Source_Rank);
    ...
    Communicator.Bcast(&(IP.Ref_State_BC_North.d()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_North.vx()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_North.vy()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_North.vz()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_North.B1x()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_North.B1y()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_North.B1z()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_North.B0x()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_North.B0y()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_North.B0z()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    ...
    Communicator.Bcast(&(IP.Ref_State_BC_South.d()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_South.vx()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_South.vy()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_South.vz()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_South.B1x()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_South.B1y()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_South.B1z()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_South.B0x()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_South.B0y()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_South.B0z()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    ...
    Communicator.Bcast(&(IP.Ref_State_BC_East.d()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_East.vx()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_East.vy()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_East.vz()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_East.B1x()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_East.B1y()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_East.B1z()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_East.B0x()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_East.B0y()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_East.B0z()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    ...
    Communicator.Bcast(&(IP.Ref_State_BC_West.d()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_West.vx()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_West.vy()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_West.vz()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_West.B1x()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_West.B1y()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_West.B1z()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_West.B0x()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_West.B0y()),
		       1,
		       MPI::DOUBLE,Source_Rank);
    Communicator.Bcast(&(IP.Ref_State_BC_West.B0z()),
		       1,
		       MPI::DOUBLE,Source_Rank);
 ...
 *                                                      
 ********************************************************/
void Get_Next_Input_Control_Parameter(MHD2D_Input_Parameters &IP) {
 ...
 *                                                      
 ********************************************************/
int Parse_Next_Input_Control_Parameter(MHD2D_Input_Parameters &IP) {
 ...
 *                                                      
 ********************************************************/
int Process_Input_Control_Parameter_File(MHD2D_Input_Parameters &Input_Parameters,
   ...
   /* Copy input file name (a string) to appropriate input parameter variable. */
    ...
    if (error_flag) {
       cout << "\n MHD2D ERROR: Unable to open MHD2D input data file.\n";
       return (error_flag);
    } /* endif */
    ...
    while (1) {
       ...
       if (Command_Flag == EXECUTE_CODE) {
          ...
          break;
                  ...
                  Command_Flag == INVALID_INPUT_VALUE) {
          line_number = -line_number;
          cout << "\n MHD2D ERROR: Error reading MHD2D data at line #"
