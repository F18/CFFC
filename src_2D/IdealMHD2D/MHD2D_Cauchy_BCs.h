/*!\file MHD2D_Cauchy_BCs.h
  \brief Header file defining specializations of Cauchy_BCs template class for MHD2D solution states. */

#ifndef _MHD2D_CAUCHY_BCS_INCLUDED
#define _MHD2D_CAUCHY_BCS_INCLUDED
...
#include "MHD3DState.h"					  /* Include MHD2D solution states header file */
#include "../HighOrderReconstruction/Cauchy_BoundaryConditions.h" /* Include Cauchy_BCs header file */

//////////////////////////////////////////////////////////
// Specialized routines for MHD2D solution states     //
//////////////////////////////////////////////////////////
 ...
 */
template<> inline
void Cauchy_BCs<MHD2D_pState>::SetCharacteristicConstraintsBasedOnBCtype(const int & BCtype){
