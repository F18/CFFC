...
#ifndef _EMBEDDEDBOUNDARIES2D_LESPREMIXED2D_INCLUDED
#define _EMBEDDEDBOUNDARIES2D_LESPREMIXED2D_INCLUDED

// Include 2D LESPremixed quadrilateral mesh solution header file.
 ...
 **********************************************************************/
template <> inline void EmbeddedBoundaries2D<LESPremixed2D_cState,
 ...
 **********************************************************************/
template <> inline int EmbeddedBoundaries2D<LESPremixed2D_cState,
					    LESPremixed2D_pState,
					    LESPremixed2D_Quad_Block,
					    LESPremixed2D_Input_Parameters>::
 ...
 **********************************************************************/
template <> inline double EmbeddedBoundaries2D<LESPremixed2D_cState,
					       LESPremixed2D_pState,
					       LESPremixed2D_Quad_Block,
					       LESPremixed2D_Input_Parameters>::
 ...
 *                                                                    *
 **********************************************************************/
template <> int EmbeddedBoundaries2D<LESPremixed2D_cState,
				     LESPremixed2D_pState,
				     LESPremixed2D_Quad_Block,
				     LESPremixed2D_Input_Parameters>::
dUdt_Residual_Evaluation(const double &Time) {
  ...
  LESPremixed2D_pState Wu, Wd, dWdxl, dWdyl, dWdxr, dWdyr;
	    ...
	    // Compute the cell centred stress tensor and heat flux vector if required.
 		...
 		(Local_SolnBlk[nb].Flow_Type && Local_SolnBlk[nb].Axisymmetric)) {
 	      Local_SolnBlk[nb].W[i][j].ComputeViscousTerms(Local_SolnBlk[nb].dWdx[i][j],
							    ...
							    Local_SolnBlk[nb].Wall[i][j].ywall,
							    Local_SolnBlk[nb].Wall[i][j].yplus);
 ...
 **********************************************************************/
template <> double EmbeddedBoundaries2D<LESPremixed2D_cState,
					LESPremixed2D_pState,
					LESPremixed2D_Quad_Block,
					LESPremixed2D_Input_Parameters>::
Ywall(const int &nb, const int &i, const int &j) {
  return Local_SolnBlk[nb].Wall[i][j].ywall;
}
...
Yplus(const int &nb, const int &i, const int &j) {
  return Local_SolnBlk[nb].Wall[i][j].yplus;
}


#endif // _EMBEDDEDBOUNDARIES2D_LESPREMIXED2D_INCLUDED
