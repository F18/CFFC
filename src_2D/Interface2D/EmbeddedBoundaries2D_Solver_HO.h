/*****************************************************************************
 * EmbeddedBoundaries2D_Solver_HO.h: 2D Embedded Boundaries multi-block      *
 *  quadrilateral mesh solvers for solvers coupled with the high-order grid. *
 ****************************************************************************/
...
int EmbeddedBoundaries2D_Solver_HO(char *Input_File_Name_ptr, int batch_flag) {
