    ...
    for ( i_blk = 0 ; i_blk <= Soln_Block_List.Nblk-1 ; ++i_blk ) {
       ...
       if (Soln_Block_List.Block[i_blk].used && 
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min0 = Soln_ptr[i_blk].ICl;
                i_max0 = Soln_ptr[i_blk].ICl+((Soln_ptr[i_blk].ICu-Soln_ptr[i_blk].ICl+1)/2+
					      (Soln_Block_List.Block[i_blk].infoN[0].dimen.ghost-1)/2);
	        i_min1 = Soln_ptr[i_blk].ICu-((Soln_ptr[i_blk].ICu-Soln_ptr[i_blk].ICl+1)/2+
					      (Soln_Block_List.Block[i_blk].infoN[1].dimen.ghost-1)/2);
                i_max1 = Soln_ptr[i_blk].ICu;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].JCu-(Soln_Block_List.Block[i_blk].infoN[0].dimen.ghost-1)/2;
	        j_max0 = Soln_ptr[i_blk].JCu;
	        j_min1 = Soln_ptr[i_blk].JCu-(Soln_Block_List.Block[i_blk].infoN[1].dimen.ghost-1)/2;
	     ...
	     if (i != 0) return(2201);
          ...
          if (Send_Mesh_Geometry_Only ||
	        ...
	        i_max0 = Soln_ptr[i_blk].Grid.INl+((Soln_ptr[i_blk].Grid.INu-Soln_ptr[i_blk].Grid.INl)/2+
						   (Soln_Block_List.Block[i_blk].infoN[0].dimen.ghost+1)/2);
	        i_min1 = Soln_ptr[i_blk].Grid.INu-((Soln_ptr[i_blk].Grid.INu-Soln_ptr[i_blk].Grid.INl)/2+
						   (Soln_Block_List.Block[i_blk].infoN[1].dimen.ghost+1)/2);
	        i_max1 = Soln_ptr[i_blk].Grid.INu;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].Grid.JNu-1-(Soln_Block_List.Block[i_blk].infoN[0].dimen.ghost-1)/2;
	        j_max0 = Soln_ptr[i_blk].Grid.JNu-1;
	        j_min1 = Soln_ptr[i_blk].Grid.JNu-1-(Soln_Block_List.Block[i_blk].infoN[1].dimen.ghost-1)/2;
	        j_max1 = Soln_ptr[i_blk].Grid.JNu-1;
	        j_inc = 1;
                i_ref0 = i_min0;
                j_ref0 = j_max0+1;
                i_ref1 = i_min1+(Soln_Block_List.Block[i_blk].infoN[1].dimen.ghost+1)/2;
                j_ref1 = j_max1+1;
             } else if (Soln_Block_List.Block[i_blk].infoN[0].dimen.j > 0) {
		   ...
		   for ( j = j_min0 ;  ((j_inc+1)/2) ? (j <= j_max0):(j >= j_max0) ; j += j_inc ) {
		     if (!(Soln_Block_List.Block[i_blk].infoN[0].dimen.ghost%2 && j == j_min0)) {
		       for ( i = i_min0 ;  ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
			 // Evaluate SW sub (fine) cell SW node location.
			 if (!(Soln_Block_List.Block[i_blk].infoN[0].dimen.ghost%2 && i == i_max0)) {
			   for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			     l0 = l0 + 1;
			 ...
			 if (i != i_max0) {
			   for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			     ...
			     Soln_Block_List.message_reschange_northface_sendbuf[i_blk][0][l0] =
                               HALF*(Soln_ptr[i_blk].Grid.Node[i][j].X[k]+
                                     Soln_ptr[i_blk].Grid.Node[i+1][j].X[k])-x_ref[k];
			   } /* endfor */
			 } /* endif */
		       } /* endfor */
		     } /* endif */
			 ...
			 for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			   ...
			   Soln_Block_List.message_reschange_northface_sendbuf[i_blk][0][l0] =
			     HALF*(Soln_ptr[i_blk].Grid.Node[i][j].X[k]+
				   Soln_ptr[i_blk].Grid.Node[i][j+1].X[k])-x_ref[k];
			 } /* endfor */
		       } /* endif */
			   ...
			   Soln_Block_List.message_reschange_northface_sendbuf[i_blk][0][l0] =
			     Soln_ptr[i_blk].Grid.Cell[i][j].Xc[k]-x_ref[k];
                         } /* endfor */
		       } /* endif */
		     } /* endfor */
		   } /* endfor */
		  ...
		  for ( j = j_min1 ;  ((j_inc+1)/2) ? (j <= j_max1):(j >= j_max1) ; j += j_inc ) {
		    if (!(Soln_Block_List.Block[i_blk].infoN[1].dimen.ghost%2 && j == j_min1)) {
		      for ( i = i_min1 ;  ((i_inc+1)/2) ? (i <= i_max1):(i >= i_max1) ; i += i_inc ) {
			// Evaluate SW sub (fine) cell SW node location.
			if (!(Soln_Block_List.Block[i_blk].infoN[1].dimen.ghost%2 && i == i_min1)) {
			  for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			    l1 = l1 + 1;
	        ...
	        j_inc = -1;
             ...
             if (i_inc > 0) {
                for ( k = 1 ; k <= 2; ++ k) {
                   for ( j  = j_min0 ; ((j_inc+1)/2) ? (j <= j_max0):(j >= j_max0) ; j += j_inc ) {
		     for (int ng = 0; ng < Soln_Block_List.Block[i_blk].infoN[0].dimen.ghost; ng++) {
		       l0++;
       ...
       if (Soln_Block_List.Block[i_blk].used && 
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min0 = Soln_ptr[i_blk].ICl;
                i_max0 = Soln_ptr[i_blk].ICl+((Soln_ptr[i_blk].ICu-Soln_ptr[i_blk].ICl+1)/2+
					      (Soln_Block_List.Block[i_blk].infoS[0].dimen.ghost-1)/2);
	        i_min1 = Soln_ptr[i_blk].ICu-((Soln_ptr[i_blk].ICu-Soln_ptr[i_blk].ICl+1)/2+
					      (Soln_Block_List.Block[i_blk].infoS[1].dimen.ghost-1)/2);
                i_max1 = Soln_ptr[i_blk].ICu;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].JCl;
	        j_max0 = Soln_ptr[i_blk].JCl+(Soln_Block_List.Block[i_blk].infoS[0].dimen.ghost-1)/2;
	        j_min1 = Soln_ptr[i_blk].JCl;
	        j_max1 = Soln_ptr[i_blk].JCl+(Soln_Block_List.Block[i_blk].infoS[1].dimen.ghost-1)/2;
	        j_inc = 1;
             } else if (Soln_Block_List.Block[i_blk].infoS[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICl+(Soln_ptr[i_blk].ICu-Soln_ptr[i_blk].ICl+1)/2;
	        i_max0 = Soln_ptr[i_blk].ICl;
	     ...
	     if (i != 0) return(2101);
          ...
          if (Send_Mesh_Geometry_Only ||
	        ...
	        j_max0 = Soln_ptr[i_blk].Grid.JNl+(Soln_Block_List.Block[i_blk].infoS[0].dimen.ghost-1)/2;
	        j_min1 = Soln_ptr[i_blk].Grid.JNl;
	        j_max1 = Soln_ptr[i_blk].Grid.JNl+(Soln_Block_List.Block[i_blk].infoS[1].dimen.ghost-1)/2;
	        j_inc = 1;
                i_ref0 = i_min0;
                j_ref0 = j_min0;
                i_ref1 = i_min1+(Soln_Block_List.Block[i_blk].infoS[1].dimen.ghost+1)/2;
                j_ref1 = j_min1;
             } else if (Soln_Block_List.Block[i_blk].infoS[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].Grid.INl+(Soln_ptr[i_blk].Grid.INu-Soln_ptr[i_blk].Grid.INl)/2+1;
	        i_max0 = Soln_ptr[i_blk].Grid.INl;
		  ...
		  for ( j = j_min0 ;  ((j_inc+1)/2) ? (j <= j_max0):(j >= j_max0) ; j += j_inc ) {
		    for ( i = i_min0 ;  ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
		      ...
		      if (!(Soln_Block_List.Block[i_blk].infoS[0].dimen.ghost%2 && i == i_max0)) {
			for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			  l0 = l0 + 1;
		    ...
		    if (!(Soln_Block_List.Block[i_blk].infoS[0].dimen.ghost%2 && j == j_max0)) {
		      for ( i = i_min0 ;  ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
			...
			if (i != i_max0) {
			  for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			    ...
			    Soln_Block_List.message_reschange_southface_sendbuf[i_blk][0][l0] =
			      HALF*(Soln_ptr[i_blk].Grid.Node[i][j+1].X[k]+
				    Soln_ptr[i_blk].Grid.Node[i+1][j+1].X[k])-x_ref[k];
			  } /* endfor */
			} /* endif */
		      } /* endfor */
		    } /* endif */
		  ...
		  for ( j = j_min1 ;  ((j_inc+1)/2) ? (j <= j_max1):(j >= j_max1) ; j += j_inc ) {
		    for ( i = i_min1 ;  ((i_inc+1)/2) ? (i <= i_max1):(i >= i_max1) ; i += i_inc ) {
	              // Evaluate SW sub (fine) cell NW node location.
		      if (!(Soln_Block_List.Block[i_blk].infoS[1].dimen.ghost%2 && i == i_min1)) {
			for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			  l1 = l1 + 1;
		    ...
		    if (!(Soln_Block_List.Block[i_blk].infoS[1].dimen.ghost%2 && j == j_max1)) {
		      for ( i = i_min1 ;  ((i_inc+1)/2) ? (i <= i_max1):(i >= i_max1) ; i += i_inc ) {
			// Evaluate NW sub (fine) cell NW node location.
			if (!(Soln_Block_List.Block[i_blk].infoS[1].dimen.ghost%2 && i == i_min1)) {
			  for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
	        ...
	        j_inc = -1;
             ...
             if (i_inc > 0) {
                for ( k = 1 ; k <= 2; ++ k) {
                   for ( j  = j_min0 ; ((j_inc+1)/2) ? (j <= j_max0):(j >= j_max0) ; j += j_inc ) {
		     for (int ng = 0; ng < Soln_Block_List.Block[i_blk].infoS[0].dimen.ghost; ng++) {
                      l0++;
                   ...
                   for ( j  = j_min1 ; ((j_inc+1)/2) ? (j <= j_max1):(j >= j_max1) ; j += j_inc ) {
		     for (int ng = 0; ng < Soln_Block_List.Block[i_blk].infoS[1].dimen.ghost; ng++) {
		       l1++;
       ...
       if (Soln_Block_List.Block[i_blk].used && 
          ...
          if (!Send_Mesh_Geometry_Only) {
             if (Soln_Block_List.Block[i_blk].infoE[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoE[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICu-(Soln_Block_List.Block[i_blk].infoE[0].dimen.ghost-1)/2;
	        i_max0 = Soln_ptr[i_blk].ICu;
	        i_min1 = Soln_ptr[i_blk].ICu-(Soln_Block_List.Block[i_blk].infoE[1].dimen.ghost-1)/2;
	        i_max1 = Soln_ptr[i_blk].ICu;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].JCl;
                j_max0 = Soln_ptr[i_blk].JCl+((Soln_ptr[i_blk].JCu-Soln_ptr[i_blk].JCl+1)/2+
					      (Soln_Block_List.Block[i_blk].infoE[0].dimen.ghost-1)/2);
	        j_min1 = Soln_ptr[i_blk].JCu-((Soln_ptr[i_blk].JCu-Soln_ptr[i_blk].JCl+1)/2+
					      (Soln_Block_List.Block[i_blk].infoE[1].dimen.ghost-1)/2);
                j_max1 = Soln_ptr[i_blk].JCu;
	        j_inc = 1;
             } else if (Soln_Block_List.Block[i_blk].infoE[0].dimen.j > 0) {
	     ...
	     if (i != 0) return(1201);
          ...
          if (Send_Mesh_Geometry_Only ||
             ...
             if (Soln_Block_List.Block[i_blk].infoE[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoE[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].Grid.INu-(Soln_Block_List.Block[i_blk].infoE[0].dimen.ghost+1)/2;
	        i_max0 = Soln_ptr[i_blk].Grid.INu-1;
	        i_min1 = Soln_ptr[i_blk].Grid.INu-(Soln_Block_List.Block[i_blk].infoE[1].dimen.ghost+1)/2;
	        i_max1 = Soln_ptr[i_blk].Grid.INu-1;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].Grid.JNl;
	        j_max0 = Soln_ptr[i_blk].Grid.JNl+((Soln_ptr[i_blk].Grid.JNu-Soln_ptr[i_blk].Grid.JNl)/2+
						   (Soln_Block_List.Block[i_blk].infoE[0].dimen.ghost+1)/2);
	        j_min1 = Soln_ptr[i_blk].Grid.JNu-((Soln_ptr[i_blk].Grid.JNu-Soln_ptr[i_blk].Grid.JNl)/2+
						   (Soln_Block_List.Block[i_blk].infoE[1].dimen.ghost+1)/2);
	        j_max1 = Soln_ptr[i_blk].Grid.JNu;
	        j_inc = 1;
                i_ref0 = i_min1+(Soln_Block_List.Block[i_blk].infoE[0].dimen.ghost+1)/2;
                j_ref0 = j_min0;
                i_ref1 = i_min1+(Soln_Block_List.Block[i_blk].infoE[1].dimen.ghost+1)/2;
                j_ref1 = j_min1+(Soln_Block_List.Block[i_blk].infoE[1].dimen.ghost+1)/2;
             } else if (Soln_Block_List.Block[i_blk].infoE[0].dimen.j > 0) {
		  ...
		  for ( j = j_min0 ; ((j_inc+1)/2) ? (j <= j_max0):(j >= j_max0) ; j += j_inc ) {
		    for ( i = i_min0 ;  ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
		      if (!(Soln_Block_List.Block[i_blk].infoE[0].dimen.ghost%2 && j == j_max0)) {
			// Evaluate SW sub (fine) cell SW node location.
			if (!(Soln_Block_List.Block[i_blk].infoE[0].dimen.ghost%2 && i == i_min0)) {
			  for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			    l0 = l0 + 1;
		  ...
		  for ( j = j_min1 ; ((j_inc+1)/2) ? (j <= j_max1):(j >= j_max1) ; j += j_inc ) {
		    for ( i = i_min1 ;  ((i_inc+1)/2) ? (i <= i_max1):(i >= i_max1) ; i += i_inc ) {
		      if (!(Soln_Block_List.Block[i_blk].infoE[1].dimen.ghost%2 && j == j_min1)) {
			// Evaluate SW sub (fine) cell SW node location.
			if (!(Soln_Block_List.Block[i_blk].infoE[1].dimen.ghost%2 && i == i_min1)) {
			  for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			    l1 = l1 + 1;
	        ...
	        j_inc = -1;
             ...
             if (j_inc > 0) {
                for ( k = 1 ; k <= 2; ++ k) {
                   for ( i  = i_min0 ; ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
		     for (int ng = 0; ng < Soln_Block_List.Block[i_blk].infoE[0].dimen.ghost; ng++) {
		       l0++;
		       ...
		       Soln_Block_List.message_reschange_eastface_sendbuf[i_blk][0][l0] = 
                   ...
                   for ( i  = i_min1 ; ((i_inc+1)/2) ? (i <= i_max1):(i >= i_max1) ; i += i_inc ) {
		     for (int ng = 0; ng < Soln_Block_List.Block[i_blk].infoE[1].dimen.ghost; ng++) {
		       l1++;
       ...
       if (Soln_Block_List.Block[i_blk].used && 
          ...
          if (!Send_Mesh_Geometry_Only) {
             if (Soln_Block_List.Block[i_blk].infoW[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICl;
	        i_max0 = Soln_ptr[i_blk].ICl+(Soln_Block_List.Block[i_blk].infoW[0].dimen.ghost-1)/2;
	        i_min1 = Soln_ptr[i_blk].ICl;
	        i_max1 = Soln_ptr[i_blk].ICl+(Soln_Block_List.Block[i_blk].infoW[1].dimen.ghost-1)/2;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].JCl;
                j_max0 = Soln_ptr[i_blk].JCl+((Soln_ptr[i_blk].JCu-Soln_ptr[i_blk].JCl+1)/2+
					      (Soln_Block_List.Block[i_blk].infoW[0].dimen.ghost-1)/2);
	        j_min1 = Soln_ptr[i_blk].JCu-((Soln_ptr[i_blk].JCu-Soln_ptr[i_blk].JCl+1)/2+
					      (Soln_Block_List.Block[i_blk].infoW[1].dimen.ghost-1)/2);
                j_max1 = Soln_ptr[i_blk].JCu;
	        j_inc = 1;
             } else if (Soln_Block_List.Block[i_blk].infoW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICl;
	     ...
	     if (i != 0) return(1101);
          ...
          if (Send_Mesh_Geometry_Only ||
             ...
             if (Soln_Block_List.Block[i_blk].infoW[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].Grid.INl;
	        i_max0 = Soln_ptr[i_blk].Grid.INl+(Soln_Block_List.Block[i_blk].infoW[0].dimen.ghost-1)/2;
	        i_min1 = Soln_ptr[i_blk].Grid.INl;
	        i_max1 = Soln_ptr[i_blk].Grid.INl+(Soln_Block_List.Block[i_blk].infoW[1].dimen.ghost-1)/2;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].Grid.JNl;
	        j_max0 = Soln_ptr[i_blk].Grid.JNl+((Soln_ptr[i_blk].Grid.JNu-Soln_ptr[i_blk].Grid.JNl)/2+
						   (Soln_Block_List.Block[i_blk].infoW[0].dimen.ghost+1)/2);
	        ...
	        j_inc = 1;
                ...
                j_ref0 = j_min0;
                i_ref1 = i_min1;
                j_ref1 = j_min1+(Soln_Block_List.Block[i_blk].infoW[1].dimen.ghost+1)/2;
             } else if (Soln_Block_List.Block[i_blk].infoW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].Grid.INl;
	        i_max0 = Soln_ptr[i_blk].Grid.INl;
	        i_min1 = Soln_ptr[i_blk].Grid.INl;
		  ...
		  for ( j = j_min0 ; ((j_inc+1)/2) ? (j <= j_max0):(j >= j_max0) ; j += j_inc ) {
		    for ( i = i_min0 ;  ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
		      if (!(Soln_Block_List.Block[i_blk].infoW[0].dimen.ghost%2 && j == j_max0)) {
			...
			if (!(Soln_Block_List.Block[i_blk].infoW[0].dimen.ghost%2 && i == i_max0)) {
			  for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			    l0 = l0 + 1;
			...
			if (!(Soln_Block_List.Block[i_blk].infoW[0].dimen.ghost%2 && i == i_max0)) {
			  for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
                            ...
                            Soln_Block_List.message_reschange_westface_sendbuf[i_blk][0][l0] =
			      HALF*(Soln_ptr[i_blk].Grid.Node[i+1][j].X[k]+
				    Soln_ptr[i_blk].Grid.Node[i+1][j+1].X[k])-x_ref[k];
			  } /* endfor */
			} /* endif */
		      } /* endif */
		  ...
		  for ( j = j_min1 ; ((j_inc+1)/2) ? (j <= j_max1):(j >= j_max1) ; j += j_inc ) {
		    for ( i = i_min1 ;  ((i_inc+1)/2) ? (i <= i_max1):(i >= i_max1) ; i += i_inc ) {
		      if (!(Soln_Block_List.Block[i_blk].infoW[1].dimen.ghost%2 && j == j_min1)) {
			// Evaluate SW sub (fine) cell SE node location.
			for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			  l1 = l1 + 1;
			...
			// Evaluate SE sub (fine) cell SE node location.
			if (!(Soln_Block_List.Block[i_blk].infoW[1].dimen.ghost%2 && i == i_max1)) {
			  for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			    l1 = l1 + 1;
	        ...
	        j_inc = -1;
             ...
             if (j_inc > 0) {
                for ( k = 1 ; k <= 2; ++ k) {
                   for ( i  = i_min0 ; ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
		     for (int ng = 0; ng < Soln_Block_List.Block[i_blk].infoW[0].dimen.ghost; ng++) {
		       l0++;
		       ...
		       Soln_Block_List.message_reschange_westface_sendbuf[i_blk][0][l0] = 
                   ...
                   for ( i  = i_min1 ; ((i_inc+1)/2) ? (i <= i_max1):(i >= i_max1) ; i += i_inc ) {
		     for (int ng = 0; ng < Soln_Block_List.Block[i_blk].infoW[1].dimen.ghost; ng++) {
		       l1++;
       ...
       if (Soln_Block_List.Block[i_blk].used && 
          ...
          if (!Send_Mesh_Geometry_Only) {
             if (Soln_Block_List.Block[i_blk].infoNW[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoNW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICl;
                i_max0 = Soln_ptr[i_blk].ICl+(Soln_Block_List.Block[i_blk].infoNW[0].dimen.ghost-1)/2;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].JCu-(Soln_Block_List.Block[i_blk].infoNW[0].dimen.ghost-1)/2;
	        j_max0 = Soln_ptr[i_blk].JCu;
	        j_inc = 1;
             } else if (Soln_Block_List.Block[i_blk].infoNW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICl;
	     ...
	     if (i != 0) return(4200);
          ...
          if (Send_Mesh_Geometry_Only ||
             ...
             if (Soln_Block_List.Block[i_blk].infoNW[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoNW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].Grid.INl;
	        i_max0 = Soln_ptr[i_blk].Grid.INl+(Soln_Block_List.Block[i_blk].infoNW[0].dimen.ghost-1)/2;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].Grid.JNu-(Soln_Block_List.Block[i_blk].infoNW[0].dimen.ghost-1)/2-1;
	        j_max0 = Soln_ptr[i_blk].Grid.JNu-1;
	        j_inc = 1;
                i_ref0 = i_min0;
                j_ref0 = j_min0+(Soln_Block_List.Block[i_blk].infoNW[0].dimen.ghost-1)/2+1;
             } else if (Soln_Block_List.Block[i_blk].infoNW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].Grid.INl;
	        i_max0 = Soln_ptr[i_blk].Grid.INl;
	        i_inc = -1;
	        ...
	        j_inc = -1;
             ...
             if (j_inc > 0) {
                if (i_inc > 0) {
		   for ( j = j_min0 ;  ((j_inc+1)/2) ? (j <= j_max0):(j >= j_max0) ; j += j_inc ) {
		     if (!(Soln_Block_List.Block[i_blk].infoNW[0].dimen.ghost%2 && j == j_min0)) {
		       for ( i = i_min0 ;  ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
			 // Evaluate SW sub (fine) cell SE node location.
			 for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			   l0 = l0 + 1;
			 ...
			 // Evaluate SE sub (fine) cell SE node location.
			 if (!(Soln_Block_List.Block[i_blk].infoNW[0].dimen.ghost%2 && i == i_max0)) {
			   for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			     l0 = l0 + 1;
       ...
       if (Soln_Block_List.Block[i_blk].used && 
          ...
          if (!Send_Mesh_Geometry_Only) {
             if (Soln_Block_List.Block[i_blk].infoNE[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoNE[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICu-(Soln_Block_List.Block[i_blk].infoNE[0].dimen.ghost-1)/2;
                i_max0 = Soln_ptr[i_blk].ICu;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].JCu-(Soln_Block_List.Block[i_blk].infoNE[0].dimen.ghost-1)/2;
	        j_max0 = Soln_ptr[i_blk].JCu;
	        j_inc = 1;
            } else if (Soln_Block_List.Block[i_blk].infoNE[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICu;
	     ...
	     if (i != 0) return(5200);
          ...
          if (Send_Mesh_Geometry_Only ||
             ...
             if (Soln_Block_List.Block[i_blk].infoNE[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoNE[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].Grid.INu-1-(Soln_Block_List.Block[i_blk].infoNE[0].dimen.ghost-1)/2;
	        i_max0 = Soln_ptr[i_blk].Grid.INu-1;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].Grid.JNu-(Soln_Block_List.Block[i_blk].infoNE[0].dimen.ghost-1)/2-1;
	        j_max0 = Soln_ptr[i_blk].Grid.JNu-1;
	        j_inc = 1;
                i_ref0 = i_max0+1;
                j_ref0 = j_min0+(Soln_Block_List.Block[i_blk].infoN[0].dimen.ghost-1)/2+1;
             } else if (Soln_Block_List.Block[i_blk].infoNE[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].Grid.INu-1;
	        i_max0 = Soln_ptr[i_blk].Grid.INu-1;
	        i_inc = -1;
	        ...
	        j_inc = -1;
             ...
             if (j_inc > 0) {
                if (i_inc > 0) {
		   for ( j = j_min0 ;  ((j_inc+1)/2) ? (j <= j_max0):(j >= j_max0) ; j += j_inc ) {
		     if (!(Soln_Block_List.Block[i_blk].infoNE[0].dimen.ghost%2 && j == j_min0)) {
		       for ( i = i_min0 ;  ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
			 // Evaluate SW sub (fine) cell SW node location.
			 if (!(Soln_Block_List.Block[i_blk].infoNE[0].dimen.ghost%2 && i == i_min0)) {
			   for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			     l0 = l0 + 1;
	 ...
	 buffer_size_neighbour = sqr(Soln_Block_List.Block[i_blk].infoSE[0].dimen.ghost)*
          ...
          if (!Send_Mesh_Geometry_Only) {
             if (Soln_Block_List.Block[i_blk].infoSE[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoSE[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICu-(Soln_Block_List.Block[i_blk].infoSE[0].dimen.ghost-1)/2;
                i_max0 = Soln_ptr[i_blk].ICu;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].JCl;
	        j_max0 = Soln_ptr[i_blk].JCl+(Soln_Block_List.Block[i_blk].infoSE[0].dimen.ghost-1)/2;
	        j_inc = 1;
             } else if (Soln_Block_List.Block[i_blk].infoSE[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICu;
	        i_max0 = Soln_ptr[i_blk].ICu;
	     ...
	     if (i != 0) return(4100);
          ...
          if (Send_Mesh_Geometry_Only ||
             ...
             if (Soln_Block_List.Block[i_blk].infoSE[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoSE[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].Grid.INu-(Soln_Block_List.Block[i_blk].infoSE[0].dimen.ghost+1)/2;
	        i_max0 = Soln_ptr[i_blk].Grid.INu-1;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].Grid.JNl;
	        j_max0 = Soln_ptr[i_blk].Grid.JNl+(Soln_Block_List.Block[i_blk].infoSE[0].dimen.ghost-1)/2;
	        j_inc = 1;
                i_ref0 = i_max0+1;
                j_ref0 = j_min0;
             } else if (Soln_Block_List.Block[i_blk].infoSE[0].dimen.j > 0) {
		   ...
		   for ( j = j_min0 ;  ((j_inc+1)/2) ? (j <= j_max0):(j >= j_max0) ; j += j_inc ) {
		     for ( i = i_min0 ;  ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
		       // Evaluate SW sub (fine) cell NW node location.
		       if (!(Soln_Block_List.Block[i_blk].infoSE[0].dimen.ghost%2 && i == i_min0)) {
			 for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			   l0 = l0 + 1;
		     ...
		     if (!(Soln_Block_List.Block[i_blk].infoSE[0].dimen.ghost%2 && j == j_max0)) {
		       for ( i = i_min0 ;  ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
			 // Evaluate NW sub (fine) cell NW node location.
			 if (!(Soln_Block_List.Block[i_blk].infoSE[0].dimen.ghost%2 && i == i_min0)) {
			   for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
	  ...
	  buffer_size_neighbour = sqr(Soln_Block_List.Block[i_blk].infoSW[0].dimen.ghost)*
          ...
          if (!Send_Mesh_Geometry_Only) {
             if (Soln_Block_List.Block[i_blk].infoSW[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoSW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICl;
                i_max0 = Soln_ptr[i_blk].ICl+(Soln_Block_List.Block[i_blk].infoSW[0].dimen.ghost-1)/2;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].JCl;
	        j_max0 = Soln_ptr[i_blk].JCl+(Soln_Block_List.Block[i_blk].infoSW[0].dimen.ghost-1)/2;
	        j_inc = 1;
             } else if (Soln_Block_List.Block[i_blk].infoSW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].ICl;
	        i_max0 = Soln_ptr[i_blk].ICl;
	     ...
	     if (i != 0) return(5100);
          ...
          if (Send_Mesh_Geometry_Only ||
             ...
             if (Soln_Block_List.Block[i_blk].infoSW[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoSW[0].dimen.j > 0) {
	        i_min0 = Soln_ptr[i_blk].Grid.INl;
	        i_max0 = Soln_ptr[i_blk].Grid.INl+(Soln_Block_List.Block[i_blk].infoSW[0].dimen.ghost-1)/2;
	        i_inc = 1;
	        j_min0 = Soln_ptr[i_blk].Grid.JNl;
	        j_max0 = Soln_ptr[i_blk].Grid.JNl+(Soln_Block_List.Block[i_blk].infoSW[0].dimen.ghost-1)/2;
	        j_inc = 1;
                i_ref0 = i_min0;
                j_ref0 = j_min0;
             } else if (Soln_Block_List.Block[i_blk].infoSW[0].dimen.j > 0) {
		   ...
		   for ( j = j_min0 ;  ((j_inc+1)/2) ? (j <= j_max0):(j >= j_max0) ; j += j_inc ) {
			 ...
			 Soln_Block_List.message_reschange_southwestcorner_sendbuf[i_blk][l0] =
		       ...
		       if (!(Soln_Block_List.Block[i_blk].infoSW[0].dimen.ghost%2 && i == i_max0)) {
			 for ( k = 1 ; k <= NUM_COMP_VECTOR2D; ++ k) {
			   l0 = l0 + 1;
		     ...
		     if (!(Soln_Block_List.Block[i_blk].infoSW[0].dimen.ghost%2 && j == j_max0)) {
		       for ( i = i_min0 ;  ((i_inc+1)/2) ? (i <= i_max0):(i >= i_max0) ; i += i_inc ) {
...
template <class Quad_Soln_Block>
int Send_All_Messages2(Quad_Soln_Block *Soln_ptr,
		       AdaptiveBlock2D_List &Soln_Block_List,
		       const int Number_of_Solution_Variables,
		       const int Send_Mesh_Geometry_Only,
		       ostream &dout) {
    ...
    /* Load message buffers at block interfaces with no cell resolution change. */
    dout << endl << " Load_Send_Message_Buffers_NoResChange"; dout.flush();
    error_flag = Load_Send_Message_Buffers_NoResChange(Soln_ptr,
                                                       Soln_Block_List,
                                                       Number_of_Solution_Variables,
                                                       Send_Mesh_Geometry_Only);
    ...
    /* Load message buffers at block interfaces for sending from fine to coarse blocks. */
    dout << endl << " Load_Send_Message_Buffers_ResChange_FineToCoarse"; dout.flush();
    error_flag = Load_Send_Message_Buffers_ResChange_FineToCoarse(Soln_ptr,
                                                                  Soln_Block_List,
                                                                  Number_of_Solution_Variables,
                                                                  Send_Mesh_Geometry_Only,
    ...
    /* Exchange message buffers at block interfaces 
       with no cell resolution change. */
    dout << endl << " Exchange_Messages_NoResChange"; dout.flush();
    error_flag = Exchange_Messages_NoResChange(Soln_Block_List,
                                               Number_of_Solution_Variables);
    if (error_flag) {
       cout << "\n " << CFFC_Version() 
    ...
    /* Exchange message buffers at block interfaces, 
       sending messages from fine to coarse blocks. */
    dout << endl << " Exchange_Messages_ResChange_FineToCoarse"; dout.flush();
    error_flag = Exchange_Messages_ResChange_FineToCoarse(Soln_Block_List,
                                                          Number_of_Solution_Variables);
    if (error_flag) {
       cout << "\n " << CFFC_Version() 
    ...
    /* Unload message buffers at block interfaces with no cell resolution change. */
    dout << endl << " Unload_Receive_Message_Buffers_NoResChange"; dout.flush();
    error_flag = Unload_Receive_Message_Buffers_NoResChange(Soln_ptr,
                                                            Soln_Block_List,
                                                            Number_of_Solution_Variables,
                                                            Send_Mesh_Geometry_Only);
    ...
    /* Unload message buffers at block interfaces as sent from fine to coarse blocks. */
    dout << endl << " Unload_Receive_Message_Buffers_ResChange_FineToCoarse"; dout.flush();
    error_flag = Unload_Receive_Message_Buffers_ResChange_FineToCoarse(Soln_ptr,
                                                                       Soln_Block_List,
                                                                       Number_of_Solution_Variables,
                                                                       Send_Mesh_Geometry_Only,
    ...
    /* Exchange message buffers at block interfaces, 
       sending messages from coarse to fine blocks. */
    dout << endl << " Exchange_Messages_ResChange_CoarseToFine"; dout.flush();
    error_flag = Exchange_Messages_ResChange_CoarseToFine(Soln_Block_List,
                                                          Number_of_Solution_Variables);
    if (error_flag) {
       cout << "\n " << CFFC_Version() 
    ...
    /* Unload message buffers at block interfaces as sent from coarse to fine blocks. */
    dout << endl << " Unload_Receive_Message_Buffers_ResChange_CoarseToFine"; dout.flush();
    error_flag = Unload_Receive_Message_Buffers_ResChange_CoarseToFine(Soln_ptr,
                                                                       Soln_Block_List,
                                                                       Number_of_Solution_Variables,
                                                                       Send_Mesh_Geometry_Only);
    ...
    /* Update corner ghost cell information for cases where there are no corner neighbours. */
    dout << endl << " Update_Corner_Ghost_Nodes"; dout.flush();
    if (Number_of_Solution_Variables > Soln_ptr[0].NumVar() || Send_Mesh_Geometry_Only) {
      for (int nb = 0; nb < Soln_Block_List.Nblk; nb++) {
	if (Soln_Block_List.Block[nb].used == ADAPTIVEBLOCK2D_USED) {
    ...
    dout << endl << " Done Update_Corner_Ghost_Nodes"; dout.flush();
