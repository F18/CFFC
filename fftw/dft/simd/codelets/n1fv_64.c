...
/* Generated on Mon Mar 19 07:44:05 CDT 2007 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_notw_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 64 -name n1fv_64 -include n1f.h */
...
static const kdft_desc desc = { 64, "n1fv_64", {198, 0, 258, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_n1fv_64) (planner *p) {
     X(kdft_register) (p, n1fv_64, &desc);
}

#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_notw_c -simd -compact -variables 4 -pipeline-latency 8 -n 64 -name n1fv_64 -include n1f.h */
...
static const kdft_desc desc = { 64, "n1fv_64", {404, 72, 52, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_n1fv_64) (planner *p) {
     X(kdft_register) (p, n1fv_64, &desc);
}
