...
/* Generated on Mon Mar 19 07:43:56 CDT 2007 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_notw_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 7 -name n1fv_7 -include n1f.h */
...
static const kdft_desc desc = { 7, "n1fv_7", {9, 3, 21, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_n1fv_7) (planner *p) {
     X(kdft_register) (p, n1fv_7, &desc);
}

#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_notw_c -simd -compact -variables 4 -pipeline-latency 8 -n 7 -name n1fv_7 -include n1f.h */
...
static const kdft_desc desc = { 7, "n1fv_7", {18, 6, 12, 0}, &GENUS, 0, 0, 0, 0 };
void X(codelet_n1fv_7) (planner *p) {
     X(kdft_register) (p, n1fv_7, &desc);
}
