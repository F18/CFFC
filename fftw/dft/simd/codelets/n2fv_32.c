...
/* Generated on Mon Mar 19 07:45:46 CDT 2007 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_notw_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 32 -name n2fv_32 -with-ostride 2 -include n2f.h -store-multiple 2 */

/*
 * This function contains 186 FP additions, 98 FP multiplications,
 * (or, 88 additions, 0 multiplications, 98 fused multiply/add),
 * 120 stack variables, and 80 memory accesses
 */
#include "n2f.h"
...
static const kdft_desc desc = { 32, "n2fv_32", {88, 0, 98, 0}, &GENUS, 0, 2, 0, 0 };
void X(codelet_n2fv_32) (planner *p) {
     X(kdft_register) (p, n2fv_32, &desc);
}

#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_notw_c -simd -compact -variables 4 -pipeline-latency 8 -n 32 -name n2fv_32 -with-ostride 2 -include n2f.h -store-multiple 2 */

/*
 * This function contains 186 FP additions, 42 FP multiplications,
 * (or, 170 additions, 26 multiplications, 16 fused multiply/add),
 * 72 stack variables, and 80 memory accesses
 */
#include "n2f.h"
...
static const kdft_desc desc = { 32, "n2fv_32", {170, 26, 16, 0}, &GENUS, 0, 2, 0, 0 };
void X(codelet_n2fv_32) (planner *p) {
     X(kdft_register) (p, n2fv_32, &desc);
}
