...
/* Generated on Mon Mar 19 07:55:02 CDT 2007 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 2 -name t1buv_2 -include t1bu.h -sign 1 */
...
static const ct_desc desc = { 2, "t1buv_2", twinstr, &GENUS, {3, 2, 0, 0}, 0, 0, 0 };

void X(codelet_t1buv_2) (planner *p) {
     X(kdft_dit_register) (p, t1buv_2, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 2 -name t1buv_2 -include t1bu.h -sign 1 */
