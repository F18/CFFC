...
/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 8 -name t1buv_8 -include t1bu.h -sign 1 */
...
static const ct_desc desc = { 8, "t1buv_8", twinstr, &GENUS, {23, 14, 10, 0}, 0, 0, 0 };

void X(codelet_t1buv_8) (planner *p) {
     X(kdft_dit_register) (p, t1buv_8, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 8 -name t1buv_8 -include t1bu.h -sign 1 */
...
static const ct_desc desc = { 8, "t1buv_8", twinstr, &GENUS, {33, 16, 0, 0}, 0, 0, 0 };
