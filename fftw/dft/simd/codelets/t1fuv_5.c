...
/* Generated on Mon Mar 19 07:52:21 CDT 2007 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 5 -name t1fuv_5 -include t1fu.h */
...
static const ct_desc desc = { 5, "t1fuv_5", twinstr, &GENUS, {11, 10, 9, 0}, 0, 0, 0 };

void X(codelet_t1fuv_5) (planner *p) {
     X(kdft_dit_register) (p, t1fuv_5, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 5 -name t1fuv_5 -include t1fu.h */
...
static const ct_desc desc = { 5, "t1fuv_5", twinstr, &GENUS, {17, 11, 3, 0}, 0, 0, 0 };
