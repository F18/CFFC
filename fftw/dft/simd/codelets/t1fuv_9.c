...
/* Generated on Mon Mar 19 07:52:23 CDT 2007 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 9 -name t1fuv_9 -include t1fu.h */
...
static const ct_desc desc = { 9, "t1fuv_9", twinstr, &GENUS, {20, 20, 34, 0}, 0, 0, 0 };

void X(codelet_t1fuv_9) (planner *p) {
     X(kdft_dit_register) (p, t1fuv_9, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 9 -name t1fuv_9 -include t1fu.h */
...
static const ct_desc desc = { 9, "t1fuv_9", twinstr, &GENUS, {38, 26, 16, 0}, 0, 0, 0 };
