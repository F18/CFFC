...
/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 3 -name t1fuv_3 -include t1fu.h */
...
static const ct_desc desc = { 3, "t1fuv_3", twinstr, &GENUS, {5, 5, 3, 0}, 0, 0, 0 };

void X(codelet_t1fuv_3) (planner *p) {
     X(kdft_dit_register) (p, t1fuv_3, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 3 -name t1fuv_3 -include t1fu.h */
...
static const ct_desc desc = { 3, "t1fuv_3", twinstr, &GENUS, {7, 5, 1, 0}, 0, 0, 0 };
