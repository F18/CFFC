...
/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 6 -name t1buv_6 -include t1bu.h -sign 1 */
...
static const ct_desc desc = { 6, "t1buv_6", twinstr, &GENUS, {17, 12, 6, 0}, 0, 0, 0 };

void X(codelet_t1buv_6) (planner *p) {
     X(kdft_dit_register) (p, t1buv_6, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 6 -name t1buv_6 -include t1bu.h -sign 1 */
...
static const ct_desc desc = { 6, "t1buv_6", twinstr, &GENUS, {21, 12, 2, 0}, 0, 0, 0 };
