...
/* Generated on Mon Mar 19 07:57:42 CDT 2007 */

#include "codelet-rdft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_hc2cdft_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 12 -dif -sign 1 -name hc2cbdftv_12 -include hc2cbv.h */

/*
 * This function contains 71 FP additions, 51 FP multiplications,
 * (or, 45 additions, 25 multiplications, 26 fused multiply/add),
 * 88 stack variables, and 24 memory accesses
 */
#include "hc2cbv.h"
...
static const hc2c_desc desc = { 12, "hc2cbdftv_12", twinstr, &GENUS, {45, 25, 26, 0} };

void X(codelet_hc2cbdftv_12) (planner *p) {
     X(khc2c_register) (p, hc2cbdftv_12, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_hc2cdft_c -simd -compact -variables 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 12 -dif -sign 1 -name hc2cbdftv_12 -include hc2cbv.h */

/*
 * This function contains 71 FP additions, 30 FP multiplications,
 * (or, 67 additions, 26 multiplications, 4 fused multiply/add),
 * 90 stack variables, and 24 memory accesses
 */
#include "hc2cbv.h"
...
static const hc2c_desc desc = { 12, "hc2cbdftv_12", twinstr, &GENUS, {67, 26, 4, 0} };
