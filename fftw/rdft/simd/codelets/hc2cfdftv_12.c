...
/* Generated on Mon Mar 19 07:57:40 CDT 2007 */

#include "codelet-rdft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_hc2cdft_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 12 -dit -name hc2cfdftv_12 -include hc2cfv.h */

/*
 * This function contains 71 FP additions, 66 FP multiplications,
 * (or, 41 additions, 36 multiplications, 30 fused multiply/add),
 * 86 stack variables, and 24 memory accesses
 */
#include "hc2cfv.h"
...
static const hc2c_desc desc = { 12, "hc2cfdftv_12", twinstr, &GENUS, {41, 36, 30, 0} };

void X(codelet_hc2cfdftv_12) (planner *p) {
     X(khc2c_register) (p, hc2cfdftv_12, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_hc2cdft_c -simd -compact -variables 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 12 -dit -name hc2cfdftv_12 -include hc2cfv.h */

/*
 * This function contains 71 FP additions, 41 FP multiplications,
 * (or, 67 additions, 37 multiplications, 4 fused multiply/add),
 * 58 stack variables, and 24 memory accesses
 */
#include "hc2cfv.h"
...
static const hc2c_desc desc = { 12, "hc2cfdftv_12", twinstr, &GENUS, {67, 37, 4, 0} };
