...
/* Generated by: ../../../genfft/gen_hc2cdft_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 6 -dif -sign 1 -name hc2cbdftv_6 -include hc2cbv.h */

/*
 * This function contains 29 FP additions, 24 FP multiplications,
 * (or, 17 additions, 12 multiplications, 12 fused multiply/add),
 * 38 stack variables, and 12 memory accesses
 */
#include "hc2cbv.h"
...
static const hc2c_desc desc = { 6, "hc2cbdftv_6", twinstr, &GENUS, {17, 12, 12, 0} };

void X(codelet_hc2cbdftv_6) (planner *p) {
     X(khc2c_register) (p, hc2cbdftv_6, &desc, HC2C_VIA_DFT);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_hc2cdft_c -simd -compact -variables 4 -pipeline-latency 8 -trivial-stores -variables 32 -no-generate-bytw -n 6 -dif -sign 1 -name hc2cbdftv_6 -include hc2cbv.h */

/*
 * This function contains 29 FP additions, 14 FP multiplications,
 * (or, 27 additions, 12 multiplications, 2 fused multiply/add),
 * 41 stack variables, and 12 memory accesses
 */
#include "hc2cbv.h"
...
static const hc2c_desc desc = { 6, "hc2cbdftv_6", twinstr, &GENUS, {27, 12, 2, 0} };
