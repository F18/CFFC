...
{                                                                      
    ...
    MV_Vector_float(unsigned int, const float&);   
                                                     
                                                    
    MV_Vector_float(float*, unsigned int);      
    MV_Vector_float(const float*, unsigned int);        
    ...
    //
    MV_Vector_float(float* d, unsigned int N, MV_Vector_::ref_type i) :
                            p_(d), dim_(N), ref_(i) {}
