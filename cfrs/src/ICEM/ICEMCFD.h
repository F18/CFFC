...
#ifndef _GRID2D_ADJUSTED_QUAD_BLOCK_INCLUDED
#include "Grid2DAdjustedQuad.h"
#endif // _GRID2D_ADJUSTED_QUAD_BLOCK_INCLUDED
...
extern Grid2D_Adjusted_Quad_Block** ICEMCFD_Read(char **filenames,
						 Grid2D_Adjusted_Quad_Block **Grid_ptr,
						 int *domx_buf,
						 int *domy_buf);
