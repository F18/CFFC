...
double Test_Example19 (double x);

/********************************************************
 * Function Test_Example20:                             *
 *          f(x) = exp(x)                               *
 *******************************************************/

double Test_Example20 (double x);

double Test_Example20_Integral (double x1, double x2);
