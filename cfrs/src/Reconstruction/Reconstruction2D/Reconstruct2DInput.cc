/* Reconstruct2DInput.cc:  Subroutines for 
                           2D Reconstuct Input Classes. */

/* Include Reconstruct 2D input parameter header file. */
...
/***************************************************************
 * Reconstruct2D_Input_Parameters -- Input-output operators. *
 ***************************************************************/
ostream &operator << (ostream &out_file,
  ...
  if (IP.TestF != NULL){
    ...
    out_file << "\n\n Solving 2D Reconstruction for the function \""
	     << IP.Function_Type << "\"";
    out_file << "\n  -> Method: "
	     << IP.Method_Used;
...
/*************************************************************
 * _Reconstruct2D_Input_Parameters -- External subroutines. *
 *************************************************************/
 ...
 *                                                      *
 ********************************************************/
void Open_Input_File(Reconstruct2D_Input_Parameters &IP) {
 ...
 *                                                      *
 ********************************************************/
void Close_Input_File(Reconstruct2D_Input_Parameters &IP) {
 ...
 *                                                      *
 ********************************************************/
void Set_Default_Input_Parameters(Reconstruct2D_Input_Parameters &IP) {

    int i;

    strcpy(IP.Input_File_Name, "reconstruct2D.in");
    // Method settings
    ...
    IP.IntTestF = Test_Default2D_Integral;
 ...
 *                                                      *
 ********************************************************/
void Get_Next_Input_Control_Parameter(Reconstruct2D_Input_Parameters &IP) {
 ...
 *                                                      *
 ********************************************************/
int Parse_Next_Input_Control_Parameter(Reconstruct2D_Input_Parameters &IP) {
 ...
 *                                                      *
 ********************************************************/
int Process_Input_Control_Parameter_File(Reconstruct2D_Input_Parameters
					 &Input_Parameters,
    ...
    if (error_flag) {
       cout << "\n Reconstruction2D ERROR: Unable to open Reconstruction2D input"
	    << " data file.\n";
       return (error_flag);
    } /* endif */
    ...
    while (1) {
       ...
       if (Command_Flag == EXECUTE_CODE) {
          ...
          cout << "\n Reconstruction2D ERROR: Error reading Reconstruction2D"
	       << " data at line #"
