    ...
    for (int k = Grid.KCl-Grid.Nghost; k <= Grid.KCu+Grid.Nghost; ++k) {
        for (int j  = Grid.JCl-Grid.Nghost; j <= Grid.JCu+Grid.Nghost; ++j ) {
            for (int i = Grid.ICl-Grid.Nghost; i <= Grid.ICu+Grid.Nghost; ++i ) {
                ...
                Out_File << " " << W[i][j][k].T() 
                         << " " << W[i][j][k].M()
                         << " " << W[i][j][k].SFS_Kinetic_Energy(dWdx[i][j][k],dWdy[i][j][k],dWdz[i][j][k],Grid.volume(i,j,k))
...
//template<>
//void Hexa_Block<LES3D_Polytropic_pState,LES3D_Polytropic_cState>::
//BCs(Input_Parameters<LES3D_Polytropic_pState,LES3D_Polytropic_cState> &IPs) {
//
...
//            
//           case BC_REFLECTION :
//             W[ICl-1][j][k] = LES3D_Polytropic_pState::Reflect(W[ICl][j][k],Grid.nfaceW(ICl,j,k));
//             U[ICl-1][j][k] = W[ICl-1][j][k].U();
//             W[ICl-2][j][k] = LES3D_Polytropic_pState::Reflect(W[ICl+1][j][k],Grid.nfaceW(ICl,j,k));
//             U[ICl-2][j][k] = W[ICl-2][j][k].U();
//             break;
//
//           case BC_NO_SLIP :
//             W[ICl-1][j][k] = LES3D_Polytropic_pState::NoSlip(W[ICl][j][k],
//                                                      WoW[j][k],
//                                                      Grid.nfaceW(ICl,j,k),
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
//             U[ICl-1][j][k] = W[ICl-1][j][k].U();
//             W[ICl-2][j][k] = LES3D_Polytropic_pState::NoSlip(W[ICl+1][j][k],
//                                                      WoW[j][k],
//                                                      Grid.nfaceW(ICl,j,k),
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
...
//
//           case BC_MOVING_WALL :
//             W[ICl-1][j][k] = LES3D_Polytropic_pState::MovingWall(W[ICl][j][k],
//                                                          WoW[j][k],
//                                                          Grid.nfaceW(ICl,j,k),
...
//                                                          FIXED_TEMPERATURE_WALL);
//             U[ICl-1][j][k] = W[ICl-1][j][k].U();
//             W[ICl-2][j][k] = LES3D_Polytropic_pState::MovingWall(W[ICl+1][j][k], 
//                                                          WoW[j][k], 
//                                                          Grid.nfaceW(ICl,j,k),
//                                                          MOVING_WALL_VELOCITY, 
//                                                          IPs.Pressure_Gradient,
...
//
//           case BC_REFLECTION :
//             W[ICu+1][j][k] = LES3D_Polytropic_pState::Reflect(W[ICu][j][k],Grid.nfaceE(ICu,j,k));
//             U[ICu+1][j][k] = W[ICu+1][j][k].U();
//             W[ICu+2][j][k] = LES3D_Polytropic_pState::Reflect(W[ICu-1][j][k],Grid.nfaceE(ICu,j,k));
//             U[ICu+2][j][k] = W[ICu+2][j][k].U();
//             break;
//
//           case BC_NO_SLIP :
//             W[ICu+1][j][k] = LES3D_Polytropic_pState::NoSlip(W[ICu][j][k],
//                                                      WoE[j][k],
//                                                      Grid.nfaceE(ICu,j,k),
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
//             U[ICu+1][j][k] = W[ICu+1][j][k].U();
//             W[ICu+2][j][k] = LES3D_Polytropic_pState::NoSlip(W[ICu-1][j][k],
//                                                      WoE[j][k],
//                                                      Grid.nfaceE(ICu,j,k),
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
...
//
//           case BC_MOVING_WALL :
//             W[ICu+1][j][k] = LES3D_Polytropic_pState::MovingWall(W[ICu][j][k],
//                                                          WoE[j][k],
//                                                          Grid.nfaceE(ICu,j,k),
//                                                          MOVING_WALL_VELOCITY,
//                                                          IPs.Pressure_Gradient,
//                                                          FIXED_TEMPERATURE_WALL);
//             U[ICu+1][j][k] = W[ICu+1][j][k].U();
//             W[ICu+2][j][k] = LES3D_Polytropic_pState::MovingWall(W[ICu-1][j][k], 
//                                                          WoW[j][k], 
//                                                          Grid.nfaceW(ICu,j,k),
//                                                          MOVING_WALL_VELOCITY, 
//                                                          IPs.Pressure_Gradient,
...
//            
//           case BC_REFLECTION :
//             W[i][JCu+1][k] = LES3D_Polytropic_pState::Reflect(W[i][JCu][k],Grid.nfaceN(i,JCu,k));
//             U[i][JCu+1][k] = W[i][ JCu+1][k].U();
//             W[i][JCu+2][k] = LES3D_Polytropic_pState::Reflect(W[i][JCu-1][k],Grid.nfaceN(i,JCu,k));
//             U[i][JCu+2][k] = W[i][JCu+2][k].U();
//             break;
//
//           case BC_NO_SLIP :
//             W[i][JCu+1][k] = LES3D_Polytropic_pState::NoSlip(W[i][JCu][k],
//                                                      WoN[i][k],
//                                                      Grid.nfaceN(i,JCu,k),
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
//             U[i][JCu+1][k] = W[i][JCu+1][k].U();
//             W[i][JCu+2][k] = LES3D_Polytropic_pState::NoSlip(W[i][JCu-1][k], 
//                                                      WoN[i][k],
//                                                      Grid.nfaceN(i,JCu,k),
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
...
//            
//           case BC_MOVING_WALL :
//             W[i][JCu+1][k] = LES3D_Polytropic_pState::MovingWall(W[i][JCu][k], 
//                                                          WoN[i][k],
//                                                          Grid.nfaceN(i,JCu,k),
//                                                          MOVING_WALL_VELOCITY,
//                                                          IPs.Pressure_Gradient,
//                                                          FIXED_TEMPERATURE_WALL);
//             U[i][JCu+1][k] = W[i][JCu+1][k].U();
//             W[i][JCu+2][k] = LES3D_Polytropic_pState::MovingWall(W[i][JCu-1][k], 
//                                                          WoN[i][k],
//                                                          Grid.nfaceN(i,JCu,k),
//                                                          MOVING_WALL_VELOCITY,
//                                                          IPs.Pressure_Gradient,
...
//
//           case BC_REFLECTION :
//             W[i][JCl-1][k] = LES3D_Polytropic_pState::Reflect(W[i][JCl][k],Grid.nfaceS(i,JCl,k));
//             U[i][JCl-1][k] = W[i][JCl-1][k].U();
//             W[i][JCl-2][k] = LES3D_Polytropic_pState::Reflect(W[i][JCl+1][k],Grid.nfaceS(i,JCl,k));
//             U[i][JCl-2][k] = W[i][JCl-2][k].U();
//             break;
//
//           case BC_NO_SLIP :
//             W[i][JCl-1][k] = LES3D_Polytropic_pState::NoSlip(W[i][JCl][k], 
//                                                      WoS[i][k], 
//                                                      Grid.nfaceS(i,JCl,k),
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
//             U[i][JCl-1][k] = W[i][JCl-1][k].U();
//             W[i][JCl-2][k] = LES3D_Polytropic_pState::NoSlip(W[i][JCl+1][k], 
//                                                      WoS[i][k],
//                                                      Grid.nfaceS(i,JCl,k),   
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
...
// 
//           case BC_MOVING_WALL :
//             W[i][JCl-1][k] = LES3D_Polytropic_pState::MovingWall(W[i][JCl][k], 
//                                                          WoS[i][k], 
//                                                          Grid.nfaceS(i,JCl,k),
//                                                          MOVING_WALL_VELOCITY,
//                                                          IPs.Pressure_Gradient, 
//                                                          FIXED_TEMPERATURE_WALL);
//             U[i][JCl-1][k] = W[i][JCl-1][k].U();
//             W[i][JCl-2][k] = LES3D_Polytropic_pState::MovingWall(W[i][JCl+1][k],
//                                                          WoS[i][k],
//                                                          Grid.nfaceS(i,JCl,k),
//                                                          MOVING_WALL_VELOCITY, 
//                                                          IPs.Pressure_Gradient,
...
//
//           case BC_REFLECTION :
//             W[i][j][KCl-1] = LES3D_Polytropic_pState::Reflect(W[i][j][KCl],Grid.nfaceBot(i,j,KCl));
//             U[i][j][KCl-1] = W[i][j][KCl-1].U();
//             W[i][j][KCl-2] = LES3D_Polytropic_pState::Reflect(W[i][j][KCl+1],Grid.nfaceBot(i,j,KCl));
//             U[i][j][KCl-2] = W[i][j][KCl-2].U();
//             break;
//
//           case BC_NO_SLIP :
//             W[i][j][KCl-1] = LES3D_Polytropic_pState::NoSlip(W[i][j][KCl], 
//                                                      WoB[i][j],
//                                                      Grid.nfaceBot(i,j,KCl),
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
//             U[i][j][KCl-1] = W[i][j][KCl-1].U(); 
//             W[i][j][KCl-2] = LES3D_Polytropic_pState::NoSlip(W[i][j][KCl+1], 
//                                                      WoB[i][j],
//                                                      Grid.nfaceBot(i,j,KCl),
//                                                      IPs.Pressure_Gradient,
//                                                     FIXED_TEMPERATURE_WALL);
...
//            
//           case BC_MOVING_WALL :
//             W[i][j][KCl-1] = LES3D_Polytropic_pState::MovingWall(W[i][j][KCl], 
//                                                          WoB[i][j],
//                                                          Grid.nfaceBot(i,j,KCl),
//                                                          MOVING_WALL_VELOCITY,
//                                                          IPs.Pressure_Gradient,
//                                                          FIXED_TEMPERATURE_WALL);
//             U[i][j][KCl-1] = W[i][j][KCl-1].U();
//             W[i][j][KCl-2] = LES3D_Polytropic_pState::MovingWall(W[i][j][KCl+1], 
//                                                          WoB[i][j],
//                                                          Grid.nfaceBot(i,j ,KCl),
//                                                          MOVING_WALL_VELOCITY,
//                                                          IPs.Pressure_Gradient,
...
//            
//           case BC_REFLECTION :
//             W[i][j][KCu+1] = LES3D_Polytropic_pState::Reflect(W[i][j][KCu],
//                                                       Grid.nfaceTop(i,j,KCu));
//             U[i][j][KCu+1] = W[i][j][KCu+1].U();
//             W[i][j][KCu+2] = LES3D_Polytropic_pState::Reflect(W[i][j][KCu-1],
//                                                       Grid.nfaceTop(i,j,KCu));
//             U[i][j][KCu+2] = W[i][j][KCu+2].U();
//             break;
//
//           case BC_NO_SLIP :
//             W[i][j][KCu+1] = LES3D_Polytropic_pState::NoSlip(W[i][j][KCu], 
//                                                      WoT[i][j],
//                                                      Grid.nfaceTop(i,j,KCu),
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
//             U[i][j][KCu+1] = W[i][j][KCu+1].U();
//             W[i][j][KCu+2] = LES3D_Polytropic_pState::NoSlip(W[i][j][KCu-1], 
//                                                      WoT[i][j],
//                                                      Grid.nfaceTop(i,j,KCu),
//                                                      IPs.Pressure_Gradient,
//                                                      FIXED_TEMPERATURE_WALL);
...
//            
//           case BC_MOVING_WALL :
//             W[i][j][KCu+1] = LES3D_Polytropic_pState::MovingWall(W[i][j][KCu], 
//                                                          WoT[i][j],
//                                                          Grid.nfaceTop(i,j,KCu),
//                                                          MOVING_WALL_VELOCITY,
//                                                          IPs.Pressure_Gradient,
//                                                          FIXED_TEMPERATURE_WALL);
//             U[i][j][KCu+1] = W[i][j][KCu+1].U();
//             W[i][j][KCu+2] = LES3D_Polytropic_pState::MovingWall(W[i][j][KCu-1], 
//                                                          WoT[i][j],
//                                                          Grid.nfaceTop(i,j,KCu),
//                                                          MOVING_WALL_VELOCITY,
//                                                          IPs.Pressure_Gradient,
