 ...
 *******************************************************************
 **********                                               **********
 ******            LES3DPolytropic Version 1.00              *******
 ****                       (07/19/07)                          ****
 ****                                                           ****
 ****         Solver for LES Equations Governing Flow of        ****
 ****         Polytropic Gases in Three Space Dimensions        ****
 ****                                                           ****
...
int main(int num_arg, char *arg_ptr[]) {
   ...
   char *program_title_ptr = 
     "LES3D: Solver for the LES Equations Governing Polytropic in 3 Space Dimensions.";
   ...
   // Input file name:
   char *Input_File_Name_ptr = "les3D.in";
   ...
   /* Parse and interpret command line arguments.  Note that there
      ...
      the standard input data file "les3Dpolytropic.in". */
   ...
   if (error_flag) {
     cout << "\n LES3Dpolytropic ERROR: Invalid command line argument.\n";
     return (error_flag);
   } /* endif */
   ...
   ********************************************************/
   ...
   if (CFFC_Primary_MPI_Processor() && help_flag) {
      cout << "Usage:\n";
      cout << "les3Dpolytropic [-v] [-h] [-i] [-b] [-f name] [-t name number]\n";
      ...
      cout << " -f name  use `name' input data file (`les3D.in' is default)\n";
      cout << " -t              run all available test suites\n" 
	   ...
	   << "                 a particular test-number \n"
 	   << "                 example: les3Dpolytropic -t MyTestSuit 3\n"
   ...
   error_flag = HexaSolver<LES3D_Polytropic_pState, 
                           LES3D_Polytropic_cState>
   ...
   if (CFFC_Primary_MPI_Processor() && !batch_flag) 
      cout << "\n\nLES3DPolytropic: Execution complete.\n\n";

   //Ending properly
   return (0);
   
   /* End les3Dpolytropic program. */
