...
ICs(Input_Parameters<NavierStokes3D_Polytropic_pState, 
   ...
   switch(IPs.i_ICs) {
      ...
      case IC_SOD_XDIR :
         Wl = NavierStokes3D_Polytropic_pState(DENSITY_STDATM, 
                                                     Vector3D_ZERO,
                                                     PRESSURE_STDATM);
         Wr = NavierStokes3D_Polytropic_pState(DENSITY_STDATM*8.0, 
                                                     Vector3D_ZERO,
	 ...
	 break;
      ...
      case IC_SHOCK_BOX :
         Wl = NavierStokes3D_Polytropic_pState(IPs.Wo);
         Wl.rho = DENSITY_STDATM;
         Wl.v = Vector3D_ZERO;
         Wl.p = PRESSURE_STDATM;
         Wr = NavierStokes3D_Polytropic_pState(IPs.Wo);
