...
!  END
!  SPECIES
!  H2   H    O2   OH   H2O  HO2  H2O2 CH3  CH4  CO   CO2  CH2O C2H2 C2H4 C2H6 NH3
!  NO   HCN  N2
!  END
!  REACTIONS
!  END
...
!
!
      SUBROUTINE CPLX15STEP30(P, T, Y, WDOT)
!      SUBROUTINE CKWYP (P, T, Y, ICKWRK, RCKWRK, WDOT)
! This routine can be changed to be compatible with CKWYR by
! replacing the above subroutine heading with the line below
! and by changing the section of computing XCON.
!      SUBROUTINE CKWYR (RHO, T, Y, ICKWRK, RCKWRK, WDOT)
!
!     This routine is automatically produced by CARM
!     for computing sources of reduced mechanism.
!     (Version: 1.0.18      Last updated on 11-3-99    )
!
! 15-step from gri30.mod (10/03/00)
!
!      SUMMARY OF REDUCED MECHANISM:
!      TOTAL NUMBER OF SPECIES= 19 WITH  15 STEPS
! ( 1)    2H +  2OH =  2H2 + O2
! ( 2)    2H = H2
! ( 3)   H + HO2 = H2 + O2
! ( 4)   H + H2O2 = H2 + HO2
...
!                   Dimension Y(*) at least  19 (total number of species)
!                   Species must be arranged in the order of:
!                   Y( 1)=    H2
!                   Y( 2)=    H
!                   Y( 3)=    O2
!                   Y( 4)=    OH
...
!
!   compute concentrations from mass fractions
! section for routine compatible with CKWYP
      ...
      ENDDO
! Replacing the above section by following lines for CKWYR
!      DO K = 1, KK
!        XCON(K) = RHO*Y(K) / WT(K)
!      ENDDO
!
...
!
      CALL CAMR3THIRDB( XM, XH2, XH, XO2, XOH, XH2O, XHO2, XH2O2, XCH3, XCH4, &
                   XCO, XCO2, XCH2O, XC2H2, XC2H4, XC2H6, XNH3, XNO, &
                   XHCN, XN2 )
!
!   SET THE ELEMENTARY RATES
!
      CALL CAMR3ELEMRATE( RF, RB, T, XM, TOLD )
!
...
!
      DO 40 K = 1, KSS
        ...
        LBOUND(K) = .TRUE.
 40   CONTINUE
      CALL CAMR3UPVALUE( 1, B, BIG, LBOUND, CONMAX, XNNH, XC2H, XCN, XCH3O, &
      ...
      DO 30 N = 1, NITER
          ...
          LITER = .TRUE.
          CONMAX = 0.0
        CALL CAMR3STEADYE( ABV, DEN, RF, RB, XM, ADJ, CONMAX, SMALL, LBOUND, &
...
!
      CALL CAMR3NETRATE( W, RF, RB, XM, XH2, XH, XO, XO2, XOH, XH2O, XHO2, &
...
! N2
      ...
      RETURN
      END
      SUBROUTINE CAMR3THIRDB( XM, XH2, XH, XO2, XOH, XH2O, XHO2, XH2O2, XCH3, &
...
!
      ...
      SUBROUTINE CAMR3ELEMRATE( RF, RB, T, XM, TOLD )
...
!   RATE CONSTANTS FOR SKELETAL MECHANSIM
      ...
      SUBROUTINE CAMR3STEADYE( ABV, DEN, RF, RB, XM, ADJ, CONMX, SMALL, &
...
!     STEADY-STATE EXPRESSION FOR C3H8
...
!     STEADY-STATE EXPRESSION FOR C3H7
...
!     STEADY-STATE EXPRESSION FOR CH2CHO
...
!     STEADY-STATE EXPRESSION FOR CH3CHO
...
!     STEADY-STATE EXPRESSION FOR CH2CO
      ...
      SUBROUTINE CAMR3UPVALUE( IOPT, VNEW, BIG, LBOUND, CONMAX, XNNH, XC2H, &
...
!*****END single precision
      ...
      ELSEIF( IOPT .ceq. 2 ) THEN
        CALL CAMR3EXBOUND( XNNH, VNEW(1), LBOUND(1),CONMAX,BIG)
        CALL CAMR3EXBOUND( XC2H, VNEW(2), LBOUND(2),CONMAX,BIG)
        CALL CAMR3EXBOUND( XCN, VNEW(3), LBOUND(3),CONMAX,BIG)
        CALL CAMR3EXBOUND( XCH3O, VNEW(4), LBOUND(4),CONMAX,BIG)
        CALL CAMR3EXBOUND( XHOCN, VNEW(5), LBOUND(5),CONMAX,BIG)
        CALL CAMR3EXBOUND( XCH2S, VNEW(6), LBOUND(6),CONMAX,BIG)
        CALL CAMR3EXBOUND( XNO2, VNEW(7), LBOUND(7),CONMAX,BIG)
        CALL CAMR3EXBOUND( XC2H5, VNEW(8), LBOUND(8),CONMAX,BIG)
        CALL CAMR3EXBOUND( XC3H8, VNEW(9), LBOUND(9),CONMAX,BIG)
        CALL CAMR3EXBOUND( XC3H7, VNEW(10), LBOUND(10),CONMAX,BIG)
        CALL CAMR3EXBOUND( XC2H3, VNEW(11), LBOUND(11),CONMAX,BIG)
        CALL CAMR3EXBOUND( XCH2CHO, VNEW(12), LBOUND(12),CONMAX,BIG)
        CALL CAMR3EXBOUND( XCH2OH, VNEW(13), LBOUND(13),CONMAX,BIG)
        CALL CAMR3EXBOUND( XHCO, VNEW(14), LBOUND(14),CONMAX,BIG)
        CALL CAMR3EXBOUND( XCH3OH, VNEW(15), LBOUND(15),CONMAX,BIG)
        CALL CAMR3EXBOUND( XHCCOH, VNEW(16), LBOUND(16),CONMAX,BIG)
        CALL CAMR3EXBOUND( XO, VNEW(17), LBOUND(17),CONMAX,BIG)
        CALL CAMR3EXBOUND( XN2O, VNEW(18), LBOUND(18),CONMAX,BIG)
        CALL CAMR3EXBOUND( XCH2, VNEW(19), LBOUND(19),CONMAX,BIG)
        CALL CAMR3EXBOUND( XHNCO, VNEW(20), LBOUND(20),CONMAX,BIG)
        CALL CAMR3EXBOUND( XNH2, VNEW(21), LBOUND(21),CONMAX,BIG)
        CALL CAMR3EXBOUND( XCH, VNEW(22), LBOUND(22),CONMAX,BIG)
        CALL CAMR3EXBOUND( XC, VNEW(23), LBOUND(23),CONMAX,BIG)
        CALL CAMR3EXBOUND( XN, VNEW(24), LBOUND(24),CONMAX,BIG)
        CALL CAMR3EXBOUND( XH2CN, VNEW(25), LBOUND(25),CONMAX,BIG)
        CALL CAMR3EXBOUND( XHCNN, VNEW(26), LBOUND(26),CONMAX,BIG)
        CALL CAMR3EXBOUND( XCH3CHO, VNEW(27), LBOUND(27),CONMAX,BIG)
        CALL CAMR3EXBOUND( XHCCO, VNEW(28), LBOUND(28),CONMAX,BIG)
        CALL CAMR3EXBOUND( XHCNO, VNEW(29), LBOUND(29),CONMAX,BIG)
        CALL CAMR3EXBOUND( XNCO, VNEW(30), LBOUND(30),CONMAX,BIG)
        CALL CAMR3EXBOUND( XNH, VNEW(31), LBOUND(31),CONMAX,BIG)
        CALL CAMR3EXBOUND( XHNO, VNEW(32), LBOUND(32),CONMAX,BIG)
        CALL CAMR3EXBOUND( XCH2CO, VNEW(33), LBOUND(33),CONMAX,BIG)
      ...
      SUBROUTINE CAMR3EXBOUND( VOLD, B, LBOUND, CONMAX, BIG )
...
!*****END single precision
      ...
      SUBROUTINE CAMR3NETRATE( W, RF, RB, XM, XH2, XH, XO, XO2, XOH, XH2O, &
