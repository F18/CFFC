...
/*          } */
         ...
         Local_Adaptive_Block_List.Block[ blknumber_convt[nb].blknum].info.be_on_grid_boundary =
            Octree.Blocks[blknumber_convt[nb].cpu][blknumber_convt[nb].blknum]->block.info.be_on_grid_boundary;
