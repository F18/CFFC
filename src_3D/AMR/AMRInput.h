...
class AMR_Input_Parameters{
 ...
 public:
  ...
  //! Number of processors (computational units) involved in computation
  int Number_of_Processors;
  //! Number of blocks per processor
  int Number_of_Blocks_Per_Processor;
  //@}

  //@{ @name AMR input parameters:
  //! Dynamic AMR flag (1=perform AMR, 0=no AMR)
  int AMR;
  ...
  //! Morton ordering flag (1=perform Morton re-ordering, 0=no Morton ordering)
  int Morton;
  //! Frequency of application of Morton re-ordering
