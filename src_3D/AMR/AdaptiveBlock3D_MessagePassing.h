...
int Load_Send_Message_Buffers_NoResChange(Hexa_Soln_Block **Soln_ptr,
 ...
 int i_blk, buffer_size_neighbour, 
  ...
  if (Number_of_Solution_Variables != NUM_COMP_VECTOR3D &&
      ...
      Number_of_Solution_Variables != Soln_ptr[0]->NumVar() + NUM_COMP_VECTOR3D) {
    return(1);
  } /* endif */
  ...
  for ( i_blk = 0 ; i_blk < Soln_Block_List.Nblk ; ++i_blk ) {
	...
	if (Soln_Block_List.Block[i_blk].infoT[0].dimen.i > 0 &&
	  ...
	  j_inc = 1;
	  k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoT[0].dimen.ghost+1;
	  k_max = Soln_ptr[i_blk]->KCu;
	  k_inc = 1;
	  ...
	  j_max = Soln_ptr[i_blk]->JCu;
	  j_inc = 1;
	  k_min = Soln_ptr[i_blk]->KCu;
	  k_max = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoT[0].dimen.ghost+1;
	  k_inc = -1;
	...
	i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_topface_sendbuf[i_blk],
	...
	if (i != 0) return(2200);
      ...
      if (Send_Mesh_Geometry_Only || Number_of_Solution_Variables > Soln_ptr[i_blk]->NumVar()) {
	if (Soln_Block_List.Block[i_blk].infoT[0].dimen.i > 0 &&
	    Soln_Block_List.Block[i_blk].infoT[0].dimen.j > 0 &&
	    Soln_Block_List.Block[i_blk].infoT[0].dimen.k > 0) {
...
/* 	    << " j_inc= "<<j_inc<< " k_min= "<< k_min << " k_max= "<<k_max<< " k_inc= "<<k_inc; */
	...
	if (Soln_Block_List.Block[i_blk].infoB[0].dimen.i > 0 &&
	        ...
	        j_min = Soln_ptr[i_blk]->JCl;
 	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl;
                k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoB[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        j_min = Soln_ptr[i_blk]->JCl;
 	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoB[0].dimen.ghost-1;
	 ...
	 //	 cout<<"\nbuffer_size_neighbour = "<<buffer_size_neighbour <<"  Soln_Block_List.Block[i_blk].infoTN[0].dimen.i= "<<Soln_Block_List.Block[i_blk].infoTN[0].dimen.i;
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoTN[0].dimen.ghost+1;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTN[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
	        ...
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu;
	        k_max = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTN[0].dimen.ghost+1;
	        k_inc = -1;
	        ...
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu;
	        j_max = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoTN[0].dimen.ghost+1;
	        j_inc = -1;
	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTN[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_topnorthcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(5300);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
         ...
         if (!Send_Mesh_Geometry_Only) {
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoTE[0].dimen.ghost+1;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTE[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
	        ...
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu;
	        k_max = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTE[0].dimen.ghost+1;
	        k_inc = -1;
              } else if (Soln_Block_List.Block[i_blk].infoTE[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoTE[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICu;
	        i_max = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoTE[0].dimen.ghost+1;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_topeastcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(5400);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
         ...
         if (!Send_Mesh_Geometry_Only) {
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoTS[0].dimen.ghost-1;
	        j_inc = 1;
   	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTS[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
	        ...
	        j_inc = 1;
   	        k_min = Soln_ptr[i_blk]->KCu;
	        k_max = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTS[0].dimen.ghost+1;
	        k_inc = -1;
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoTS[0].dimen.ghost-1;
	        j_max = Soln_ptr[i_blk]->JCl;
	        j_inc = -1;
   	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTS[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_topsouthcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(4300);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
         ...
         if (!Send_Mesh_Geometry_Only) {
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoTW[0].dimen.ghost-1;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTW[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
	        ...
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu;
	        k_max = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTW[0].dimen.ghost+1;
	        k_inc = -1;
             } else if ( Soln_Block_List.Block[i_blk].infoTW[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoTW[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoTW[0].dimen.ghost-1;
	        i_max = Soln_ptr[i_blk]->ICl;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCu;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_topwestcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,
         ...
         if (!Send_Mesh_Geometry_Only) {
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoBN[0].dimen.ghost+1;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBN[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBN[0].dimen.ghost-1;
	        k_max = Soln_ptr[i_blk]->KCl;
	        k_inc = -1;
	        ...
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu;
	        j_max = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoBN[0].dimen.ghost+1;
	        j_inc = -1;
	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBN[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_bottomnorthcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(5500);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
         ...
         if (!Send_Mesh_Geometry_Only) {
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoBE[0].dimen.ghost+1;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBE[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBE[0].dimen.ghost-1;
	        k_max = Soln_ptr[i_blk]->KCl;
	        k_inc = -1;
              } else if (Soln_Block_List.Block[i_blk].infoBE[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoBE[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICu;
	        i_max = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoBE[0].dimen.ghost+1;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_bottomeastcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(5600);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
         ...
         if (!Send_Mesh_Geometry_Only) {
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBS[0].dimen.ghost-1;
	        j_inc = 1;
   	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBS[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBS[0].dimen.ghost-1;
	        j_inc = 1;
   	        k_min = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBS[0].dimen.ghost-1;
	        k_max = Soln_ptr[i_blk]->KCl;
	        k_inc = -1;
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBS[0].dimen.ghost-1;
	        j_max = Soln_ptr[i_blk]->JCl;
	        j_inc = -1;
   	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBS[0].dimen.ghost-1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_bottomsouthcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(4500);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
         ...
         if (!Send_Mesh_Geometry_Only) {
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoBW[0].dimen.ghost-1;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBW[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBW[0].dimen.ghost-1;
	        k_max = Soln_ptr[i_blk]->KCl;
	        k_inc = -1;
             } else if ( Soln_Block_List.Block[i_blk].infoBW[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoBW[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoBW[0].dimen.ghost-1;
	        i_max = Soln_ptr[i_blk]->ICl;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCu;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_bottomwestcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,
                                                j_min,j_max,j_inc, k_min,k_max,k_inc);
	     if (i != 0) return(4600);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].infoTNW[0].dimen.ghost*
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoTNW[0].dimen.ghost-1;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoTNW[0].dimen.ghost+1;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTNW[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
	        ...
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu;
	        k_max = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTNW[0].dimen.ghost+1;
	        k_inc = -1;
             } else if ( Soln_Block_List.Block[i_blk].infoTNW[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoTNW[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoTNW[0].dimen.ghost-1;
	        i_max = Soln_ptr[i_blk]->ICl;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoTNW[0].dimen.ghost+1;
	        j_max = Soln_ptr[i_blk]->JCu;
	        ...
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu;
	        j_max = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoTNW[0].dimen.ghost+1;
	        j_inc = -1;
	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTNW[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_topnorthwestcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,
                                                j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].infoTSE[0].dimen.ghost*
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoTSE[0].dimen.ghost+1;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoTSE[0].dimen.ghost-1;
	        j_inc = 1;
   	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTSE[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
	        ...
	        j_inc = 1;
   	        k_min = Soln_ptr[i_blk]->KCu;
	        k_max = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTSE[0].dimen.ghost+1;
	        k_inc = -1;
             } else if (Soln_Block_List.Block[i_blk].infoTSE[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoTSE[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICu;
	        i_max = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoTSE[0].dimen.ghost+1;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoTSE[0].dimen.ghost-1;
	        j_inc = 1;
	        ...
	        i_min = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoTSE[0].dimen.ghost+1;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoTSE[0].dimen.ghost-1;
	        j_max = Soln_ptr[i_blk]->JCl;
	        j_inc = -1;
   	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTSE[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_topsoutheastcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(4800);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].infoTSW[0].dimen.ghost*
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoTSW[0].dimen.ghost-1;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoTSW[0].dimen.ghost-1;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTSW[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
          } else
             if (Soln_Block_List.Block[i_blk].infoTSW[0].dimen.i > 0 &&
	        ...
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu;
	        k_max = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTSW[0].dimen.ghost+1;
	        k_inc = -1;
          } else
             if ( Soln_Block_List.Block[i_blk].infoTSW[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoTSW[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoTSW[0].dimen.ghost-1;
	        i_max = Soln_ptr[i_blk]->ICl;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoTSW[0].dimen.ghost-1;
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoTSW[0].dimen.ghost-1;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoTSW[0].dimen.ghost-1;
	        j_max = Soln_ptr[i_blk]->JCl;
	        j_inc = -1;
	        k_min = Soln_ptr[i_blk]->KCu;
	        k_max = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTSW[0].dimen.ghost+1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_topsouthwestcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(5800);
      ...
      ///////////////////////////////////////////////////////////////////////////
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].infoBNW[0].dimen.ghost*
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoBNW[0].dimen.ghost-1;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoBNW[0].dimen.ghost+1;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBNW[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBNW[0].dimen.ghost-1;
	        k_max = Soln_ptr[i_blk]->KCl;
	        k_inc = -1;
             } else if ( Soln_Block_List.Block[i_blk].infoBNW[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoBNW[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoBNW[0].dimen.ghost-1;
	        i_max = Soln_ptr[i_blk]->ICl;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoBNW[0].dimen.ghost+1;
	        j_max = Soln_ptr[i_blk]->JCu;
	        ...
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu;
	        j_max = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoBNW[0].dimen.ghost+1;
	        j_inc = -1;
	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBNW[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_bottomnorthwestcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,
                                                j_min,j_max,j_inc, k_min,k_max,k_inc);
	     if (i != 0) return(4900);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].infoBNE[0].dimen.ghost*
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoBNE[0].dimen.ghost+1;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoBNE[0].dimen.ghost+1;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBNE[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBNE[0].dimen.ghost-1;
	        k_max = Soln_ptr[i_blk]->KCl;
	        k_inc = -1;
              } else if (Soln_Block_List.Block[i_blk].infoBNE[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoBNE[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICu;
	        i_max = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoBNE[0].dimen.ghost+1;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoBNE[0].dimen.ghost+1;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        ...
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu;
	        j_max = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoBNE[0].dimen.ghost+1;
	        j_inc = -1;
	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBNE[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_bottomnortheastcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(5900);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoBSE[0].dimen.ghost+1;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBSE[0].dimen.ghost-1;
	        j_inc = 1;
   	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBSE[0].dimen.ghost-1;
	        k_inc = 1;
	        ...
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBSE[0].dimen.ghost-1;
	        j_inc = 1;
   	        k_min = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBSE[0].dimen.ghost-1;
	        k_max = Soln_ptr[i_blk]->KCl;
	        k_inc = -1;
             } else if (Soln_Block_List.Block[i_blk].infoBSE[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoBSE[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICu;
	        i_max = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoBSE[0].dimen.ghost+1;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBSE[0].dimen.ghost-1;
	        j_inc = 1;
	        ...
	        i_min = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoBSE[0].dimen.ghost+1;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBSE[0].dimen.ghost-1;
	        j_max = Soln_ptr[i_blk]->JCl;
	        j_inc = -1;
   	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBSE[0].dimen.ghost-1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_bottomsoutheastcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(5000);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].infoTNE[0].dimen.ghost*
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoTNE[0].dimen.ghost+1;
                i_max = Soln_ptr[i_blk]->ICu;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoTNE[0].dimen.ghost+1;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTNE[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
	        ...
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCu;
	        k_max = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTNE[0].dimen.ghost+1;
	        k_inc = -1;
              } else if (Soln_Block_List.Block[i_blk].infoTNE[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoTNE[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICu;
	        i_max = Soln_ptr[i_blk]->ICu-Soln_Block_List.Block[i_blk].infoTNE[0].dimen.ghost+1;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoTNE[0].dimen.ghost+1;
	        j_max = Soln_ptr[i_blk]->JCu;
	        j_inc = 1;
	        ...
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCu;
	        j_max = Soln_ptr[i_blk]->JCu-Soln_Block_List.Block[i_blk].infoTNE[0].dimen.ghost+1;
	        j_inc = -1;
	        k_min = Soln_ptr[i_blk]->KCu-Soln_Block_List.Block[i_blk].infoTNE[0].dimen.ghost+1;
	        k_max = Soln_ptr[i_blk]->KCu;
	        k_inc = 1;
	        ...
	        k_inc = -1;
             ...
             i = Soln_ptr[i_blk]->LoadSendBuffer(Soln_Block_List.message_noreschange_topnortheastcorner_sendbuf[i_blk],
                                                l,buffer_size_neighbour,
                                                i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                k_min,k_max,k_inc);
	     if (i != 0) return(5700);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost*
          ...
          if (!Send_Mesh_Geometry_Only) {
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost-1;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost-1;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl;
	        k_max = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost-1;
	        k_inc = 1;
          } else
             if (Soln_Block_List.Block[i_blk].infoBSW[0].dimen.i > 0 &&
                 Soln_Block_List.Block[i_blk].infoBSW[0].dimen.j > 0 ) {
	        ...
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost-1;
	        j_inc = 1;
	        k_min = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost-1;
	        k_max = Soln_ptr[i_blk]->KCl;
	        k_inc = -1;
          } else
             if ( Soln_Block_List.Block[i_blk].infoBSW[0].dimen.j > 0 &&
                 Soln_Block_List.Block[i_blk].infoBSW[0].dimen.k > 0) {
	        i_min = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost-1;
	        i_max = Soln_ptr[i_blk]->ICl;
	        i_inc = -1;
	        j_min = Soln_ptr[i_blk]->JCl;
	        j_max = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost-1;
	        ...
	        i_min = Soln_ptr[i_blk]->ICl;
                i_max = Soln_ptr[i_blk]->ICl+Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost-1;
	        i_inc = 1;
	        j_min = Soln_ptr[i_blk]->JCl+Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost-1;
	        j_max = Soln_ptr[i_blk]->JCl;
	        j_inc = -1;
	        k_min = Soln_ptr[i_blk]->KCl+Soln_Block_List.Block[i_blk].infoBSW[0].dimen.ghost-1;
	        k_max = Soln_ptr[i_blk]->KCl;
 ...
 ***************************************************************/
template <class Hexa_Soln_Block>
int Load_Send_Message_Buffers_ResChange_FineToCoarse(Hexa_Soln_Block **Soln_ptr,
                                                     AdaptiveBlock3D_List &Soln_Block_List,
                                                     const int Number_of_Solution_Variables,
                                                     const int Send_Mesh_Geometry_Only,
 ...
 ***************************************************************/
template <class Hexa_Soln_Block>
int Load_Send_Message_Buffers_ResChange_CoarseToFine(Hexa_Soln_Block **Soln_ptr,
                                                     AdaptiveBlock3D_List &Soln_Block_List,
                                                     const int Number_of_Solution_Variables,
                                                     const int Send_Mesh_Geometry_Only) {
 ...
 ********************************************************/
template <class Hexa_Soln_Block>
int Unload_Receive_Message_Buffers_NoResChange(Hexa_Soln_Block **Soln_ptr,
                                               AdaptiveBlock3D_List &Soln_Block_List,
                                               const int Number_of_Solution_Variables,
                                               const int Send_Mesh_Geometry_Only) {
	...
	if (!Send_Mesh_Geometry_Only) {
	  ...
	  j_max = Soln_ptr[i_blk]->JCu;
	  j_inc = 1;
	  k_min = Soln_ptr[i_blk]->KCu+1;
	  k_max = Soln_ptr[i_blk]->KCu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
	  k_inc = 1;
	  i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_topface_recbuf[i_blk],
						  l,buffer_size,
						  i_min,i_max,i_inc,j_min,j_max,j_inc,
						  k_min,k_max,k_inc);
	  if (i != 0) return(2200);
	...
	/////////////////////////////////////////////////////////////////////////
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    4*Soln_Block_List.Block[i_blk].infoB[0].dimen.ghost*abs(Soln_Block_List.Block[i_blk].infoB[0].dimen.j);
	     ...
	     j_max = Soln_ptr[i_blk]->JCu;
	     j_inc = 1;
   	     k_min = Soln_ptr[i_blk]->KCl-Soln_Block_List.Block[i_blk].info.dimen.ghost;
	     k_max = Soln_ptr[i_blk]->KCl-1;
             k_inc = 1;
            i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_bottomface_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,j_min,j_max,j_inc,
                                                     k_min,k_max,k_inc);
	     if (i != 0) return(2100);
     ...
     ////////////////////////////////////////////////////////////////////////////////
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	     ...
	     i_max = Soln_ptr[i_blk]->ICu;
             ...
             k_max = Soln_ptr[i_blk]->KCu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_topnorthcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(5300);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	     ...
	     j_min = Soln_ptr[i_blk]->JCl-Soln_Block_List.Block[i_blk].info.dimen.ghost;
             ...
             k_max = Soln_ptr[i_blk]->KCu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_topsouthcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(5400);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	     ...
	     i_max = Soln_ptr[i_blk]->ICu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             ...
             k_max = Soln_ptr[i_blk]->KCu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_topeastcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(5500);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	     ...
	     i_max = Soln_ptr[i_blk]->ICl-1;
             ...
             k_max = Soln_ptr[i_blk]->KCu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_topwestcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(5600);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	     ...
	     i_max = Soln_ptr[i_blk]->ICu;
             ...
             k_max = Soln_ptr[i_blk]->KCl-1;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_bottomnorthcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(5700);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	     ...
	     j_min = Soln_ptr[i_blk]->JCl-Soln_Block_List.Block[i_blk].info.dimen.ghost;
             ...
             k_max = Soln_ptr[i_blk]->KCl-1;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_bottomsouthcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(5800);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	     ...
	     i_max = Soln_ptr[i_blk]->ICu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             ...
             k_max = Soln_ptr[i_blk]->KCl-1;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_bottomeastcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(5900);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	     ...
	     i_max = Soln_ptr[i_blk]->ICl-1;
             ...
             k_max = Soln_ptr[i_blk]->KCl-1;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_bottomwestcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(6000);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].info.dimen.ghost*
	     ...
	     i_max = Soln_ptr[i_blk]->ICl-1;
             ...
             k_max = Soln_ptr[i_blk]->KCu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_topnorthwestcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(6100);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].info.dimen.ghost*
	     ...
	     i_max = Soln_ptr[i_blk]->ICu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             ...
             k_max = Soln_ptr[i_blk]->KCu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_topsoutheastcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(6300);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].info.dimen.ghost*
	     ...
	     i_max = Soln_ptr[i_blk]->ICu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             ...
             k_max = Soln_ptr[i_blk]->KCu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_topnortheastcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(6200);
	 ...
	 buffer_size = sqr(Soln_Block_List.Block[i_blk].info.dimen.ghost)*
	   Soln_Block_List.Block[i_blk].info.dimen.ghost*
	     ...
	     i_max = Soln_ptr[i_blk]->ICl-1;
             ...
             k_max = Soln_ptr[i_blk]->KCu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_topsouthwestcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(6400);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].info.dimen.ghost*
	     ...
	     i_max = Soln_ptr[i_blk]->ICl-1;
             ...
             k_max = Soln_ptr[i_blk]->KCl-1;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_bottomnorthwestcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(6500);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].info.dimen.ghost*
	     ...
	     i_max = Soln_ptr[i_blk]->ICu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             ...
             k_max = Soln_ptr[i_blk]->KCl-1;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_bottomnortheastcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(6600);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].info.dimen.ghost*
	     ...
	     i_max = Soln_ptr[i_blk]->ICu+Soln_Block_List.Block[i_blk].info.dimen.ghost;
             ...
             k_max = Soln_ptr[i_blk]->KCl-1;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_bottomsoutheastcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(6700);
       ...
       if (Soln_Block_List.Block[i_blk].used &&
	    ...
	    Soln_Block_List.Block[i_blk].info.dimen.ghost*
	     ...
	     i_max = Soln_ptr[i_blk]->ICl-1;
             ...
             k_max = Soln_ptr[i_blk]->KCl-1;
             k_inc = 1;
             i = Soln_ptr[i_blk]->UnloadReceiveBuffer(Soln_Block_List.message_noreschange_bottomsouthwestcorner_recbuf[i_blk],
                                                     l,buffer_size,
                                                     i_min,i_max,i_inc,
                                                     j_min,j_max,j_inc,k_min,k_max,k_inc);
	     if (i != 0) return(6800);
 ...
 ******************************************************************/
template <class Hexa_Soln_Block>
int Unload_Receive_Message_Buffers_ResChange_FineToCoarse(Hexa_Soln_Block **Soln_ptr,
                                                          AdaptiveBlock3D_List &Soln_Block_List,
                                                          const int Number_of_Solution_Variables,
                                                          const int Send_Mesh_Geometry_Only,
                                                          const int Send_Conservative_Solution_Fluxes) {
 ...
 ******************************************************************/
template <class Hexa_Soln_Block>
int Unload_Receive_Message_Buffers_ResChange_CoarseToFine(Hexa_Soln_Block **Soln_ptr,
                                                          AdaptiveBlock3D_List &Soln_Block_List,
                                                          const int Number_of_Solution_Variables,
                                                          const int Send_Mesh_Geometry_Only) {
 ...
 ********************************************************/
template <class Hexa_Soln_Block>
int Send_All_Messages(Hexa_Soln_Block **Soln_ptr,
                      AdaptiveBlock3D_List &Soln_Block_List,
                      const int Number_of_Solution_Variables,
                      const int Send_Mesh_Geometry_Only) {
...
/* /\*         if (Soln_Block_List.Block[nb].used == ADAPTIVEBLOCK3D_USED) Update_Corner_Ghost_Nodes(Soln_ptr[nb].Grid); *\/ */
/* /\*       } /\\* endfor *\\/ *\/ */
/* /\*     } /\\* endif *\\/ *\/ */
 ...
 ********************************************************/
template <class Hexa_Soln_Block>
int Send_Conservative_Flux_Corrections(Hexa_Soln_Block *Soln_ptr,
                                       AdaptiveBlock3D_List &Soln_Block_List,
                                       const int Number_of_Solution_Variables) {
