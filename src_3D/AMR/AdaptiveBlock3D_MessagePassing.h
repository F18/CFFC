              ...
              for (int kk = -1; kk <= 1; kk++) {
                 ...
                 if ((num_bound_elem[i_bound_elem] == 1) && 
                    ...
                    if (!Send_Mesh_Geometry_Only) {
                       buffer_size_neighbour = ((abs(ii)*Soln_Block_List.Block[i_blk].info.dimen.ghost) + 
                       ...
                       if (Number_of_Solution_Variables > Soln_Blks[i_blk].NumVar()) {
                          buffer_size_neighbour = buffer_size_neighbour +
                                                  ((abs(ii)*Soln_Block_List.Block[i_blk].info.dimen.ghost) + 
...
/**********************************************************
 * Routine: Correct_Boundary_Exterior_Nodes               *
 *                                                        *
 *                                                        *
 *                                                        *
 **********************************************************/
