...
#include "LES/LES_Polytropic/LES3DPolytropic.h"
...
int main(int num_arg, char *arg_ptr[]) {
   ...
   } else if(strcmp(Equation_Type, "LES3DPolytropic") == 0) {
       error_flag = HexaSolver<LES3D_Polytropic_pState, LES3D_Polytropic_cState>
       (Input_File_Name_ptr, batch_flag);
