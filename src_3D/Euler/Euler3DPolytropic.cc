 ...
 *******************************************************************
 **********                                               **********
 ******             Euler3DPolytropic Version 1.00           *******
 ****                       (07/19/07)                          ****
 ****                                                           ****
...
#include "Euler3DPolytropic.h"
#include "../UnitTesting/UnitTesting.h"

/* Begin Euler3DPolytropic program. */
...
int main(int num_arg, char *arg_ptr[]) {
   ...
   char *program_title_ptr = 
     "Euler3DPolytropic: Solver for the Euler Equations Governing Polytropic Gases in 3 Space Dimensions.";
   ...
   if (error_flag) {
     cout << "\n Euler3DPolytropic ERROR: Invalid command line argument.\n";
     return (error_flag);
   } /* endif */
   ...
   ********************************************************/
   ...
   if (CFFC_Primary_MPI_Processor() && help_flag) {
      cout << "Usage:\n";
      cout << "euler3Dpolytropic [-v] [-h] [-i] [-b] [-f name] [-t name number]\n";
      ...
      cout << " -t              run all available test suites\n" 
	   ...
	   << "                 a particular test-number \n"
 	   << "                 example: euler3Dpolytropic -t MyTestSuit 3\n"
   ...
   error_flag = HexaSolver<Euler3D_Polytropic_pState, 
