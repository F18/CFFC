    ...
    if (Grid2.Allocated) {
	  ...
	  for (int j = Grid2.JNl-Grid2.Nghost; j <= Grid2.JNu+Grid2.Nghost; ++j) {
       ...
       for (int j = Grid2.JCl-Grid2.Nghost; j <= Grid2.JCu+Grid2.Nghost; ++j) {
        ...
        if (Grid2.Filter_Weights_Allocated) {
            Allocate_Filter_Weights();
            for (int k = 0; k < NCk; ++k) {
                for (int j = 0; j < NCj; ++j) {
                    for (int i = 0; i < NCi; ++i) {
                        Filter_Weights[i][j][k] = Grid2.Filter_Weights[i][j][k]; 
                        Filter_Weights_Assigned[i][j][k] = Grid2.Filter_Weights_Assigned[i][j][k]; 
                    } /* endfor */
                } /* endfor */
            } /* endfor */
        } /* endif */
        Filter_Weights_Allocated = Grid2.Filter_Weights_Allocated;
        
        if (Grid2.Derivative_Reconstruction_Weights_Allocated) {
            Allocate_Derivative_Reconstruction_Weights();
            for (int k = 0; k < NCk; ++k) {
                for (int j = 0; j < NCj; ++j) {
                    for (int i = 0; i < NCi; ++i) {
                        Derivative_Reconstruction_Weights[i][j][k] = Grid2.Derivative_Reconstruction_Weights[i][j][k]; 
                        Derivative_Reconstruction_Weights_Assigned[i][j][k] = Grid2.Derivative_Reconstruction_Weights_Assigned[i][j][k]; 
                    } /* endfor */
                } /* endfor */
            } /* endfor */
        } /* endif */
        Derivative_Reconstruction_Weights_Allocated = Grid2.Derivative_Reconstruction_Weights_Allocated;
...
void Grid3D_Hexa_Block::Allocate_Filter_Weights(void) {
...
void Grid3D_Hexa_Block::Deallocate_Filter_Weights(void) {
...
void Grid3D_Hexa_Block::Allocate_Derivative_Reconstruction_Weights(void) {
    Deallocate_Derivative_Reconstruction_Weights();
    Derivative_Reconstruction_Weights = new DenseMatrix **[NCi];
    Derivative_Reconstruction_Weights_Assigned = new bool **[NCi];
    for (int i=0; i<NCi; i++) {
        Derivative_Reconstruction_Weights[i] = new DenseMatrix *[NCj];
        Derivative_Reconstruction_Weights_Assigned[i] = new bool *[NCj];
        for (int j=0; j<NCj; j++) {
            Derivative_Reconstruction_Weights[i][j] = new DenseMatrix [NCk];
            Derivative_Reconstruction_Weights_Assigned[i][j] = new bool [NCk];
...
void Grid3D_Hexa_Block::Deallocate_Derivative_Reconstruction_Weights(void) {
