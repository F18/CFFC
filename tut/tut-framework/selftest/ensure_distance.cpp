...
void object::test<10>()
{
    ...
    try
    {
        ensure_distance("2!~1", 2, 0, 1);   /* Modified by L. Ivan, UTIAS, Aug 28, 2007 */
    ...
    try
    {
        ensure_distance("0!~1", 0, 2, 1);   /* Modified by L. Ivan, UTIAS, Aug 28, 2007 */
        throw runtime_error("ensure_distance failed");
    }
    catch (const failure&)
    {
...
void object::test<11>()
{
    ...
    try
    {
        ensure_distance(2, 0, 1);      /* Modified by L. Ivan, UTIAS, Aug 28, 2007 */
        throw runtime_error("ensure_distance failed");
    }
    catch (const failure&)
    {
    ...
    try
    {
        ensure_distance(0, 2, 1);      /* Modified by L. Ivan, UTIAS, Aug 28, 2007 */
        throw runtime_error("ensure_distance failed");
    }
    catch (const failure&)
    {
