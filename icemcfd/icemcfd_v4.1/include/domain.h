...
int df_add_primary_domain(int file_no, const char *name, 
			int imin[3], int imax[3]);

int DF_Add_Secondary_Domain(int file_no, const char *name, 
					int imin[3], int imax[3], int pid);

int df_add_secondary_domain(int file_no, 
		const char *name, int imin[3], int imax[3]);
...
int df_get_domain(int dom_file_number, 
		const char *domain_name, int *sub_dom_number);
...
int
df_add_unstruct_domain(int file_no, 
		const char *name, int dim, int start, int end);
