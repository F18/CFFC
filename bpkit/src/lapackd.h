...
extern "C"
{
  ...
  // dgelsy subroutine added by L. Ivan (UTIAS, Dec 7, 2006)
  void F77NAME(dgelsy)(integer *m, integer *n, integer *nrhs, doublereal *A, integer *lda, doublereal *B,
		       integer *ldb, integer *jpvt, doublereal *rcond, integer *rank,
